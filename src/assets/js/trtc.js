! function(e, t) {
	...
	var n, r, i, o = "object",
		...
		P = {
			f: u ? I : function(e, t) {
				...
				if (C(e, t)) return f(!l.f.call(e, t), e[t])
			}
		},
		x = function(e) {
		...
		M = L("native-function-to-string", Function.toString),
		j = s.WeakMap,
	...
	var Q = {
		...
		fe = function(e, t) {
			...
			for (; t.length > i;) C(r, n = t[i++]) && (~le(o, n) || o.push(n));
			return o
		},
		...
		be = function(e, t) {
			var n = Ce[ke(e)];
			return n == Re ? 1 : n == Te ? 0 : "function" == typeof t ? c(t) : !!t
		},
		...
		Ie = function(e, t) {
			var n, r, i, o, a, c = e.target,
				u = e.global,
				d = e.stat;
			if (n = u ? s : d ? s[c] || N(c, {}) : (s[c] || {}).prototype)
				for (r in t) {
					if (o = t[r], i = e.noTargetGet ? (a = Ee(n, r)) && a.value : n[r], !we(u ? r : c + (d ? "." : "#") + r, e.forced) &&
						void 0 !== i) {
		...
		Ne = L("wks"),
		Le = function(e) {
			return Ne[e] || (Ne[e] = Oe && De[e] || (Oe ? De : G)("Symbol." + e))
		},
		Me = Le("species"),
		je = function(e, t) {
			var n;
	...
	var ze = function(e) {
		...
		qe = function(e) {
			...
			return function(s, c, u, d) {
				for (var p, l, f = xe(s), h = g(f), m = Je(c, u, 3), v = ae(h.length), _ = 0, y = d || je, S = t ? y(s, v) : n ?
						y(s, 0) : void 0; v > _; _++)
					if ((a || _ in h) && (l = m(p = h[_], _, f), e))
						if (t) S[_] = l;
						else if (l) switch (e) {
					case 3:
						return 1;
	...
	function pt(e, t, n) {
		return (pt = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(e, t, n) {
			var r = function(e, t) {
		...
		! function(t) {
			...
			if (u) e.exports = u;
				...
				k.prototype = _.constructor = C, C.constructor = k, C[c] = k.displayName = "GeneratorFunction", u.isGeneratorFunction =
					...
					}, T(_), _[c] = "Generator", _[a] = function() {
						return this
					}, _.toString = function() {
				...
				return o._invoke = function(e, t, n) {
					...
					return function(i, o) {
						...
						for (n.method = i, n.arg = o;;) {
							...
							var c = S(e, t, n);
							if ("normal" === c.type) {
								if (r = n.done ? f : p, c.arg === h) continue;
								return {
									value: c.arg,
									done: n.done
								}
	...
	var Mt = Object.freeze({
		...
		shimPeerConnection: Nt,
		fixNegotiationNeeded: Lt,
		shimGetUserMedia: wt,
		...
		Object.defineProperty(i.prototype, "localDescription", {
			...
			null, i.prototype._dispatchEvent = function(e, t) {
				...
				if ("offer" === e.type) t = jt.splitSections(e.sdp), n = t.shift(), t.forEach(function(e, t) {
					...
					t.forEach(function(e, t) {
						...
						if (!(jt.isRejected(e) && 0 === jt.matchPrefix(e, "a=bundle-only").length) && !o.rejected) {
							var p = jt.getIceParameters(e, n),
								l = jt.getDtlsParameters(e, n);
							i && (l.role = "server"), r.usingBundle && 0 !== t || (r._gather(o.mid, t), "new" === s.state && s.start(a,
								p, i ? "controlling" : "controlled"), "new" === c.state && c.start(l));
							var f = Ut(u, d);
				...
				var s = [],
					...
					p = jt.matchPrefix(u, "a=group:BUNDLE ").length > 0;
				o.usingBundle = p;
				var l = jt.matchPrefix(u, "a=ice-options:")[0];
				return o.canTrickleIceCandidates = l ? l.substr(14).split(" ").indexOf("trickle") >= 0 : 0, c.forEach(function(r,
						c) {
						var l = jt.splitLines(r),
							f = jt.getKind(r),
						...
						if (h || "application" === f && ("DTLS/SCTP" === m || "UDP/DTLS/SCTP" === m)) o.transceivers[c] = {
							...
							if (("offer" === i.type || "answer" === i.type) && !h && p && c > 0 && o.transceivers[c] && (o._disposeIceAndDtlsTransports(
								...
								if ("answer" === i.type && !h) {
									S = (y = o.transceivers[c]).iceGatherer, b = y.iceTransport, k = y.dtlsTransport, C = y.rtpReceiver, T = y.sendEncodingParameters,
										w = y.localCapabilities, o.transceivers[c].recvEncodingParameters = R, o.transceivers[c].remoteCapabilities =
										x, o.transceivers[c].rtcpParameters = A, D.length && "new" === b.state && (!d && !O || p && 0 !== c ? D.forEach(
											function(e) {
												Gt(y.iceTransport, e)
											}) : b.setRemoteCandidates(D)), p && 0 !== c || ("new" === b.state && b.start(S, I, "controlling"), "new" ===
								...
								(y = o.transceivers[c] || o._createTransceiver(f)).mid = _, y.iceGatherer || (y.iceGatherer = o._createIceGatherer(
									c, p)), D.length && "new" === y.iceTransport.state && (!O || p && 0 !== c ? D.forEach(function(e) {
									Gt(y.iceTransport, e)
								}) : y.iceTransport.setRemoteCandidates(D)), w = e.RTCRtpReceiver.getCapabilities(f), t < 15019 && (w.codecs =
									w.codecs.filter(function(e) {
										return "rtx" !== e.name
								...
								if ("sendrecv" === v || "sendonly" === v) {
									if (L = !y.rtpReceiver, C = y.rtpReceiver || new e.RTCRtpReceiver(y.dtlsTransport, f), L) E = C.track, g &&
										...
										}), N = a[g.stream]) : (a.default || (a.default = new e.MediaStream), N = a.default)), N && (n(E, N), y.associatedRemoteMediaStreams
											.push(N)), s.push([E, C, N])
								...
								y.localCapabilities = w, y.remoteCapabilities = x, y.rtpReceiver = C, y.rtcpParameters = A, y.sendEncodingParameters =
									T, y.recvEncodingParameters = R, o._transceive(o.transceivers[c], 0, L)
							}
						}
	...
	var Kt = Object.freeze({
		shimPeerConnection: Wt,
		shimReplaceTrack: qt,
		shimGetUserMedia: zt,
		shimGetDisplayMedia: Jt
	});
	...
	const yn = function({
		...
		switch (r.browser) {
			case "chrome":
				if (!Mt || !Nt || !t.shimChrome) return n("Chrome shim is not included in this adapter release."), i;
				n("adapter.js shimming chrome."), i.browserShim = Mt, wt(e), Et(e), Nt(e), It(e), Dt(e), Pt(e), xt(e), At(e), Lt(
			...
			case "firefox":
				...
				break;
			case "edge":
				if (!Kt || !Wt || !t.shimEdge) return n("MS edge shim is not included in this adapter release."), i;
				n("adapter.js shimming edge."), i.browserShim = Kt, zt(e), Jt(e), Wt(e), qt(e), hn(e), mn(e);
				break;
			case "safari":
				if (!ln || !t.shimSafari) return n("Safari shim is not included in this adapter release."), i;
				n("adapter.js shimming safari."), i.browserShim = ln, un(e), pn(e), an(e), rn(e), on(e), dn(e), sn(e), fn(e), hn(
					e), mn(e), gn(e);
				break;
			default:
	...
	Ie({
		...
		slice: function(e, t) {
			...
			if (Pe(o) && ("function" != typeof(n = o.constructor) || n !== Array && !Pe(n.prototype) ? S(n) && null === (n =
					n[Rn]) && (n = void 0) : n = void 0, n === Array || void 0 === n)) return wn.call(o, s, c);
	...
	!u || "name" in Dn || On(Dn, "name", {
		...
		get: function() {
			try {
				return Nn.call(this).match(Ln)[1]
			} catch (e) {
				return ""
			}
		}
	...
	var Hn = function() {
		...
		function s(e, r, o) {
			...
			var p = d();
			null == p && (p = null == r ? "WARN" : r), c.setLevel(p, 0)
		}
		var c = new s,
			u = {};
	...
	Ie({
		...
		splice: function(e, t) {
			var n, r, i, o, a, s, c = xe(this),
				...
				d = ue(e, u),
				p = arguments.length;
			if (0 === p ? n = r = 0 : 1 === p ? (n = 0, r = u - d) : (n = p - 2, r = $n(Kn(ie(t), 0), u - d)), u + n - r >
	...
	var dr = !c(function() {
		...
		fr = dr ? Object.getPrototypeOf : function(e) {
			return e = xe(e), C(e, pr) ? e[pr] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor
				.prototype : e instanceof Object ? lr : null
		},
		hr = c(function() {
			fr(1)
		});
	...
	var br = RegExp.prototype,
		...
		Tr = "toString" != kr.name;
	(Cr || Tr) && X(RegExp.prototype, "toString", function() {
		var e = x(this),
			t = String(e.source),
			n = e.flags;
	...
	Ir("replace", 2, function(e, t, n) {
		return [function(n, r) {
			...
			for (var p = [];;) {
				...
				if (null === l) break;
				if (p.push(l), !u) break;
				"" === String(l[0]) && (a.lastIndex = Or(s, ae(a.lastIndex), d))
			}
			for (var f, h = "", m = 0, v = 0; v < p.length; v++) {
				l = p[v];
				for (var g = String(l[0]), _ = Nr(Lr(ie(l.index), s.length), 0), y = [], S = 1; S < l.length; S++) y.push(void 0 ===
					(f = l[S]) ? f : String(f));
				var b = l.groups;
				if (c) {
			...
			return void 0 !== o && (o = xe(o), u = jr), t.call(a, u, function(t, a) {
				...
				switch (a.charAt(0)) {
					...
					default:
						...
						if (d > c) {
							var p = Mr(d / 10);
							return 0 === p ? t : p <= c ? void 0 === i[p - 1] ? a.charAt(1) : i[p - 1] + a.charAt(1) : t
						}
						u = i[d - 1]
				}
				return void 0 === u ? "" : u
		...
		return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length ||
			4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e, n) {
				...
				for (var o, a, s, c = [], u = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e
						.sticky ? "y" : ""), d = 0, p = new RegExp(e.source, u + "g");
					(o = Bn.call(p, r)) && !((a = p.lastIndex) > d && (c.push(r.slice(d, o.index)), o.length > 1 && o.index < r.length &&
						Hr.apply(c, o.slice(1)), s = o[0].length, d = a, c.length >= i));) p.lastIndex === o.index && p.lastIndex++;
				return d === r.length ? !s && p.test("") || c.push("") : c.push(r.slice(d)), c.length > i ? c.slice(0, i) : c
				...
				var a = x(e),
					...
					c = Br(a, RegExp),
					u = a.unicode,
					d = (a.ignoreCase ? "i" : "") + (a.multiline ? "m" : "") + (a.unicode ? "u" : "") + (Jr ? "y" : "g"),
					p = new c(Jr ? a : "^(?:" + a.source + ")", d),
					l = void 0 === i ? 4294967295 : i >>> 0;
				if (0 === l) return [];
				if (0 === s.length) return null === Dr(p, s) ? [s] : [];
				for (var f = 0, h = 0, m = []; h < s.length;) {
					p.lastIndex = Jr ? h : 0;
					var v, g = Dr(p, Jr ? s : s.slice(h));
					if (null === g || (v = zr(ae(p.lastIndex + (Jr ? 0 : h)), s.length)) === f) h = Or(s, h, u);
					else {
						if (m.push(s.slice(f, h)), m.length === l) return m;
						for (var _ = 1; _ <= g.length - 1; _++)
							if (m.push(g[_]), m.length === l) return m;
						h = f = v
					}
				}
	...
	var Xr = {
		...
		merge: function e() {
			...
			for (var r = 0, i = arguments.length; r < i; r++) Qr(arguments[r], n);
			return t
		},
		...
		extend: function(e, t, n) {
			return Qr(t, function(t, r) {
				e[r] = n && "function" == typeof t ? Wr(t, n) : t
			}), e
		},
		trim: function(e) {
	...
	var ei = function(e, t, n) {
		...
		var r;
		if (n) r = n(t);
		else if (Xr.isURLSearchParams(t)) r = t.toString();
		else {
			var i = [];
			Xr.forEach(t, function(e, t) {
				null != e && (Xr.isArray(e) ? t += "[]" : e = [e], Xr.forEach(e, function(e) {
					Xr.isDate(e) ? e = e.toISOString() : Xr.isObject(e) && (e = JSON.stringify(e)), i.push(Zr(t) + "=" + Zr(e))
				}))
			}), r = i.join("&")
		}
		if (r) {
	...
	ti.prototype.use = function(e, t) {
		return this.handlers.push({
			fulfilled: e,
			rejected: t
		}), this.handlers.length - 1
	}, ti.prototype.eject = function(e) {
	...
	var ni = ti,
		ri = function(e, t, n) {
			return Xr.forEach(n, function(n) {
				e = n(e, t)
			}), e
		},
		ii = function(e) {
		...
		oi = "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ?
		window : {};
	...
	function di(e) {
		if (ci === setTimeout) return setTimeout(e, 0);
		if ((ci === ai || !ci) && setTimeout) return ci = setTimeout, setTimeout(e, 0);
		try {
			return ci(e, 0)
		} catch (t) {
			try {
	...
	"function" == typeof oi.setTimeout && (ci = setTimeout), "function" == typeof oi.clearTimeout && (ui = clearTimeout);
	var pi, li = [],
		fi = 0,
		hi = -1;

	function mi() {
		fi && pi && (fi = 0, pi.length ? li = pi.concat(li) : hi = -1, li.length && vi())
	}
	...
	function vi() {
		if (!fi) {
			...
			for (var t = li.length; t;) {
				for (pi = li, li = []; ++hi < t;) pi && pi[hi].run();
				hi = -1, t = li.length
			}
			pi = null, fi = 0,
				function(e) {
					if (ui === clearTimeout) return clearTimeout(e);
					if ((ui === si || !ui) && clearTimeout) return ui = clearTimeout, clearTimeout(e);
					try {
						ui(e)
					} catch (t) {
						try {
	...
	var yi = _i,
		...
		Ti = _i,
		Ri = _i;
	var wi = oi.performance || {},
		Ei = wi.now || wi.mozNow || wi.msNow || wi.oNow || wi.webkitNow || function() {
	...
	var Pi = {
			nextTick: function(e) {
				...
				li.push(new gi(e, t)), 1 !== li.length || fi || di(vi)
			},
			title: "browser",
			browser: 1,
			env: {},
			...
			config: {},
			uptime: function() {
				return (new Date - Ii) / 1e3
			}
		},
		xi = function(e, t) {
			Xr.forEach(e, function(n, r) {
		...
		Oi = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host",
			"if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization",
			"referer", "retry-after", "user-agent"
		],
		Di = Xr.isStandardBrowserEnv() ? function() {
			...
			return e = r(window.location.href),
				function(t) {
					var n = Xr.isString(t) ? r(t) : t;
					return n.protocol === e.protocol && n.host === e.host
				}
		}() : function() {
			return 1
		},
		Ni = Xr.isStandardBrowserEnv() ? {
			write: function(e, t, n, r, i, o) {
				var a = [];
				a.push(e + "=" + encodeURIComponent(t)), Xr.isNumber(n) && a.push("expires=" + new Date(n).toGMTString()), Xr.isString(
						r) && a.push("path=" + r), Xr.isString(i) && a.push("domain=" + i), 1 == o && a.push("secure"), document.cookie =
					a.join("; ")
			},
			read: function(e) {
		...
		Li = function(e) {
			return new Promise(function(t, n) {
				var r = e.data,
					i = e.headers;
				Xr.isFormData(r) && delete i["Content-Type"];
				...
				if (o.open(e.method.toUpperCase(), ei(e.url, e.params, e.paramsSerializer), 1), o.timeout = e.timeout, o.onreadystatechange =
					function() {
						if (o && 4 === o.readyState && (0 !== o.status || o.responseURL && 0 === o.responseURL.indexOf("file:"))) {
							var r = "getAllResponseHeaders" in o ? function(e) {
									var t, n, r, i = {};
									return e ? (Xr.forEach(e.split("\n"), function(e) {
										if (r = e.indexOf(":"), t = Xr.trim(e.substr(0, r)).toLowerCase(), n = Xr.trim(e.substr(r + 1)), t) {
											if (i[t] && Oi.indexOf(t) >= 0) return;
							...
							! function(e, t, n) {
								...
								!r || r(n.status) ? e(n) : t(Ai("Request failed with status code " + n.status, n.config, null, n.request, n))
							}(t, n, i), o = null
						}
					}, o.onabort = function() {
						o && (n(Ai("Request aborted", e, "ECONNABORTED", o)), o = null)
					}, o.onerror = function() {
						n(Ai("Network Error", e, null, o)), o = null
					}, o.ontimeout = function() {
						n(Ai("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", o)), o = null
					}, Xr.isStandardBrowserEnv()) {
					var c = Ni,
						u = (e.withCredentials || Di(e.url)) && e.xsrfCookieName ? c.read(e.xsrfCookieName) : void 0;
					u && (i[e.xsrfHeaderName] = u)
				}
				if ("setRequestHeader" in o && Xr.forEach(i, function(e, t) {
	...
	function ji(e, t) {
		!Xr.isUndefined(e) && Xr.isUndefined(e["Content-Type"]) && (e["Content-Type"] = t)
	}
	var Vi = {
		adapter: function() {
			var e;
			return void 0 !== Pi && "[object process]" === Object.prototype.toString.call(Pi) ? e = Li : "undefined" !=
				typeof XMLHttpRequest && (e = Li), e
		}(),
		transformRequest: [function(e, t) {
			return xi(t, "Accept"), xi(t, "Content-Type"), Xr.isFormData(e) || Xr.isArrayBuffer(e) || Xr.isBuffer(e) || Xr.isStream(
				e) || Xr.isFile(e) || Xr.isBlob(e) ? e : Xr.isArrayBufferView(e) ? e.buffer : Xr.isURLSearchParams(e) ? (ji(t,
				"application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : Xr.isObject(e) ? (ji(t,
	...
	Xr.forEach(["delete", "get", "head"], function(e) {
		Vi.headers[e] = {}
	}), Xr.forEach(["post", "put", "patch"], function(e) {
		Vi.headers[e] = Xr.merge(Mi)
	});
	var Ui = Vi;
	...
	var Gi = function(e) {
			var t, n;
			return Fi(e), e.baseURL && ! function(e) {
					return /^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(e)
				}(e.url) && (e.url = (t = e.baseURL, (n = e.url) ? t.replace(/\/+$/, "") + "/" + n.replace(/^\/+/, "") : t)), e.headers =
				e.headers || {}, e.data = ri(e.data, e.headers, e.transformRequest), e.headers = Xr.merge(e.headers.common || {},
					e.headers[e.method] || {}, e.headers || {}), Xr.forEach(["delete", "get", "head", "post", "put", "patch",
					"common"
				], function(t) {
					delete e.headers[t]
				}), (e.adapter || Ui.adapter)(e).then(function(t) {
					return Fi(e), t.data = ri(t.data, t.headers, e.transformResponse), t
				}, function(t) {
					return ii(t) || (Fi(e), t && t.response && (t.response.data = ri(t.response.data, t.response.headers, e.transformResponse))),
						Promise.reject(t)
				})
		},
		Bi = function(e, t) {
			t = t || {};
			var n = {};
			return Xr.forEach(["url", "method", "params", "data"], function(e) {
				void 0 !== t[e] && (n[e] = t[e])
			}), Xr.forEach(["headers", "auth", "proxy"], function(r) {
				Xr.isObject(t[r]) ? n[r] = Xr.deepMerge(e[r], t[r]) : void 0 !== t[r] ? n[r] = t[r] : Xr.isObject(e[r]) ? n[r] =
					Xr.deepMerge(e[r]) : void 0 !== e[r] && (n[r] = e[r])
			}), Xr.forEach(["baseURL", "transformRequest", "transformResponse", "paramsSerializer", "timeout",
	...
	Hi.prototype.request = function(e) {
		"string" == typeof e ? (e = arguments[1] || {}).url = arguments[0] : e = e || {}, (e = Bi(this.defaults, e)).method =
		...
		return e = Bi(this.defaults, e), ei(e.url, e.params, e.paramsSerializer).replace(/^\?/, "")
	}, Xr.forEach(["delete", "get", "head", "options"], function(e) {
		Hi.prototype[e] = function(t, n) {
			return this.request(Xr.merge(n || {}, {
				method: e,
				url: t
			}))
		}
	}), Xr.forEach(["post", "put", "patch"], function(e) {
		Hi.prototype[e] = function(t, n, r) {
			return this.request(Xr.merge(r || {}, {
				method: e,
				url: t,
				data: n
			}))
	...
	function qi(e) {
		...
		var n = this;
		e(function(e) {
			n.reason || (n.reason = new Wi(e), t(n.reason))
		})
	}
	...
	function $i(e) {
		var t = new zi(e),
			n = Wr(zi.prototype.request, t);
		return Xr.extend(n, zi.prototype, t), Xr.extend(n, t), n
	}
	var Yi = $i(Ui);
	Yi.Axios = zi, Yi.create = function(e) {
		return $i(Bi(Yi.defaults, e))
	}, Yi.Cancel = Wi, Yi.CancelToken = Ki, Yi.isCancel = ii, Yi.all = function(e) {
		return Promise.all(e)
	}, Yi.spread = function(e) {
		return function(t) {
	...
	function to(e) {
		try {
			...
			if (n.message === Zi) return "[Circular]";
			throw n
		}
	}
	...
	var lo = {
		...
		vo = "",
		go = function(e) {
			fo || (ho = "".concat(e.sdkAppId), mo = "".concat(e.userId), vo = "".concat(e.version), fo = 1)
		},
		_o = function(e, t) {
			...
			var n, r = function e() {
				for (var t = {}, n = 0; n < arguments.length; n += 1) {
					...
					for (var i in r) ro.call(r, i) && (t[i] = "object" !== Qe(r[i]) || Array.isArray(r[i]) ? r[i] : e(t[i], r[i]))
				}
				return t
			}(lo, t);
			r.capacity = r.capacity || 500;
			var i = new oo(r.capacity);
			...
			function o(e) {
				if (fo) {
					...
					eo.post(r.url, t).then(function(e) {
						i.confirm()
					}).catch(function(e) {
						console.log(e), i.fail()
					})
				}
			}
			...
			function a() {
				if (fo && !i.sent()) {
					if (!i.length()) return;
					var e = i.send();
					i.content = n ? '{"logs":['.concat(e.join(","), "]}") : e.join("\n"), o(i.content)
				}
			}
			return so = e.methodFactory, co = function(e, t, s) {
				var c = so(e, t, s),
					u = uo && r.stacktrace.levels.some(function(t) {
						return t === e
					}),
					d = ao.levels[e.toUpperCase()],
					p = d >= ao.levels[r.level.toUpperCase()];
				return function() {
					for (var t = arguments.length, l = new Array(t), f = 0; f < t; f++) l[f] = arguments[f];
					var h = no(l);
					if (p) {
						...
						if (v) {
							var g = v.split("\n");
							g.splice(0, r.stacktrace.excess + 3);
							var _ = r.stacktrace.depth;
							if (_ && g.length !== _ + 1) {
								var y = g.splice(0, _);
								v = y.join("\n"), g.length && (v += "\n    and ".concat(g.length, " more"))
							} else v = g.join("\n")
						}
						var S = r.format({
							message: h,
						...
						void 0 === n && (n = "string" != typeof S);
						var b = "";
						if (n) try {
							b += JSON.stringify(S)
						} catch (T) {
							return c.apply(void 0, l), void ao.getLogger("logger").error(T)
						} else b += S;
						fo ? (i.length() && a(), o(b)) : i.push(b)
					}
					var k = (new Date).toTimeString().replace(/.*(\d{2}:\d{2}:\d{2}).*/, "$1"),
						C = "[" + k + "] <" + e.toUpperCase() + "> " + h;
					c.apply(void 0, [C])
				}
			}, e.methodFactory = co, e.setLevel(e.getLevel()), e
		},
		yo = function() {
			if (!ao) throw new Error("You can't disable a not appled plugin");
			if (co !== ao.methodFactory) throw new Error("You can't disable a plugin after appling another plugin");
			ao.methodFactory = so, ao.setLevel(ao.getLevel()), ao = void 0, clearInterval(-1)
		},
		So = 0;
	Hn.setConfig = function(e) {
		...
		So || (Hn.info("enable upload log"), _o(Hn), So = 1)
	}, Hn.disableUploadLog = function() {
		So && (Hn.warn("disable upload log! Without log we are difficult to help you triage the issue you might run into!"),
			yo(), So = 0)
	}, Hn.enableUploadLog(), Hn.setLevel("DEBUG");
	var bo = Object.keys || function(e) {
			return fe(e, he)
		},
		ko = u ? Object.defineProperties : function(e, t) {
			x(e);
			for (var n, r = bo(t), i = r.length, o = 0; i > o;) O.f(e, n = r[o++], t[n]);
			return e
		},
		Co = te("document", "documentElement"),
		To = H("IE_PROTO"),
		Ro = function() {},
		wo = function() {
			var e, t = w("iframe"),
				n = he.length;
			for (t.style.display = "none", Co.appendChild(t), t.src = String("javascript:"), (e = t.contentWindow.document).open(),
				e.write("<script>document.F=Object<\/script>"), e.close(), wo = e.F; n--;) delete wo.prototype[he[n]];
			return wo()
		},
		Eo = Object.create || function(e, t) {
			var n;
			return null !== e ? (Ro.prototype = x(e), n = new Ro, Ro.prototype = null, n[To] = e) : n = wo(), void 0 === t ? n :
				ko(n, t)
		};
	z[To] = 1;
	var Io = ve.f,
		...
		Ao = {
			f: function(e) {
				return xo && "[object Window]" == Po.call(e) ? function(e) {
					try {
						return Io(e)
					} catch (t) {
						return xo.slice()
		...
		Mo = Le("toStringTag"),
		jo = function(e, t, n) {
			e && !C(e = n ? e : e.prototype, Mo) && Lo(e, Mo, {
				configurable: 1,
				value: t
			})
		},
		...
		Qo = L("symbols"),
		Xo = L("op-symbols"),
		Zo = L("string-to-symbol-registry"),
		ea = L("symbol-to-string-registry"),
		ta = L("wks"),
		na = s.QObject,
		ra = !na || !na.prototype || !na.prototype.findChild,
		ia = u && c(function() {
			return 7 != Eo(Ko({}, "a", {
				get: function() {
					return Ko(this, "a", {
			...
			var r = qo(Ho, t);
			r && delete Ho[t], Ko(e, t, n), r && e !== Ho && Ko(Ho, t, r)
		} : Ko,
		oa = function(e, t) {
			var n = Qo[e] = Eo(zo.prototype);
			return Go(n, {
				type: "Symbol",
				tag: e,
				description: t
		...
		aa = Oe && "symbol" == typeof zo.iterator ? function(e) {
			return "symbol" == typeof e
		} : function(e) {
			return Object(e) instanceof zo
		},
		sa = function(e, t, n) {
			e === Ho && sa(Xo, t, n), x(e);
			var r = b(t, 1);
			return x(n), C(Qo, r) ? (n.enumerable ? (C(e, Uo) && e[Uo][r] && (e[Uo][r] = 0), n = Eo(n, {
				enumerable: f(0, 0)
			})) : (C(e, Uo) || Ko(e, Uo, f(1, {})), e[Uo][r] = 1), ia(e, r, n)) : Ko(e, r, n)
		},
		ca = function(e, t) {
			x(e);
			var n = y(t),
				r = bo(n).concat(la(n));
			return Vo(r, function(t) {
				u && !ua.call(n, t) || sa(e, t, n[t])
			}), e
		},
		ua = function(e) {
			var t = b(e, 1),
				n = Yo.call(this, t);
			return this === Ho && C(Qo, t) && !C(Xo, t) ? 0 : n || !C(this, t) || !C(Qo, t) || C(this, Uo) && this[Uo][t] ? n :
				1
		},
		da = function(e, t) {
			var n = y(e),
				r = b(t, 1);
			if (n !== Ho || !C(Qo, r) || C(Xo, r)) {
				var i = qo(n, r);
				return !i || !C(Qo, r) || C(n, Uo) && n[Uo][r] || (i.enumerable = 1), i
			}
		},
		pa = function(e) {
			var t = $o(y(e)),
		...
		la = function(e) {
			var t = e === Ho,
				n = $o(t ? Xo : y(e)),
				r = [];
			return Vo(n, function(e) {
				!C(Qo, e) || t && !C(Ho, e) || r.push(Qo[e])
			}), r
		};
	Oe || (X((zo = function() {
		if (this instanceof zo) throw TypeError("Symbol is not a constructor");
		var e = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
			t = G(e),
			n = function(e) {
				this === Ho && n.call(Xo, e), C(this, Uo) && C(this[Uo], t) && (this[Uo][t] = 0), ia(this, t, f(1, e))
			};
		return u && ra && ia(Ho, t, {
			configurable: 1,
			set: n
		...
		return Bo(this).tag
	}), l.f = ua, O.f = sa, P.f = da, ve.f = Ao.f = pa, ge.f = la, u && (Ko(zo.prototype, "description", {
		configurable: 1,
		get: function() {
			return Bo(this).description
		}
	}), X(Ho, "propertyIsEnumerable", ua, {
		unsafe: 1
	})), Oo.f = function(e) {
		return oa(Le(e), e)
	}), Ie({
		...
		for: function(e) {
			var t = String(e);
			if (C(Zo, t)) return Zo[t];
			var n = zo(t);
			return Zo[t] = n, ea[n] = t, n
		},
		keyFor: function(e) {
			if (!aa(e)) throw TypeError(e + " is not a symbol");
			if (C(ea, e)) return ea[e]
		},
		useSetter: function() {
			ra = 1
		},
		...
		create: function(e, t) {
			return void 0 === t ? Eo(e) : ca(Eo(e), t)
		},
		defineProperty: sa,
		defineProperties: ca,
		...
		stringify: function(e) {
			...
			if (n = t = r[1], (S(t) || void 0 !== e) && !aa(e)) return Pe(t) || (t = function(e, t) {
				if ("function" == typeof n && (t = n.call(this, e, t)), !aa(t)) return t
			}), r[1] = t, Wo.apply(Jo, r)
		}
	}), zo.prototype[Fo] || D(zo.prototype, Fo, zo.prototype.valueOf), jo(zo, "Symbol"), z[Uo] = 1;
	var fa = O.f,
		ha = s.Symbol;
	if (u && "function" == typeof ha && (!("description" in ha.prototype) || void 0 !== ha().description)) {
		var ma = {},
			va = function() {
				var e = arguments.length < 1 || void 0 === arguments[0] ? void 0 : String(arguments[0]),
					t = this instanceof va ? new ha(e) : void 0 === e ? ha() : ha(e);
				return "" === e && (ma[t] = 1), t
			};
		ye(va, ha);
		var ga = va.prototype = ha.prototype;
		ga.constructor = va;
		var _a = ga.toString,
			ya = "Symbol(test)" == String(ha("test")),
			Sa = /^Symbol\((.*)\)[^)]+$/;
		fa(ga, "description", {
			configurable: 1,
			get: function() {
				var e = S(this) ? this.valueOf() : this,
					t = _a.call(e);
				if (C(ma, e)) return "";
				var n = ya ? t.slice(7, -1) : t.replace(Sa, "$1");
				return "" === n ? void 0 : n
			}
		}), Ie({
			global: 1,
	...
	var Ca = Le("unscopables"),
		Ta = Array.prototype;
	null == Ta[Ca] && D(Ta, Ca, Eo(null));
	var Ra, wa, Ea, Ia = function(e) {
			Ta[Ca][e] = 1
		},
		Pa = {},
		xa = Le("iterator"),
		Aa = 0;
	[].keys && ("next" in (Ea = [].keys()) ? (wa = fr(fr(Ea))) !== Object.prototype && (Ra = wa) : Aa = 1), null == Ra &&
		(Ra = {}), C(Ra, xa) || D(Ra, xa, function() {
			return this
		});
	var Oa = {
			IteratorPrototype: Ra,
			BUGGY_SAFARI_ITERATORS: Aa
		},
		Da = Oa.IteratorPrototype,
		Na = function() {
			return this
		},
		...
		Ma = Oa.IteratorPrototype,
		ja = Oa.BUGGY_SAFARI_ITERATORS,
		Va = Le("iterator"),
		Ua = function() {
			return this
		},
		Fa = function(e, t, n, r, i, o, a) {
			! function(e, t, n) {
				var r = t + " Iterator";
				e.prototype = Eo(Da, {
					next: f(1, n)
			...
			var s, c, u, d = function(e) {
				...
				l = 0,
				h = e.prototype,
				m = h[Va] || h["@@iterator"] || i && h[i],
				v = !ja && m || d(i),
				g = "Array" == t && h.entries || m;
			if (g && (s = fr(g.call(new e)), Ma !== Object.prototype && s.next && (fr(s) !== Ma && (La ? La(s, Ma) : "function" !=
					typeof s[Va] && D(s, Va, Ua)), jo(s, p, 1))), "values" == i && m && "values" !== m.name && (l = 1, v = function() {
					return m.call(this)
				}), h[Va] !== v && D(h, Va, v), Pa[t] = v, i)
				if (c = {
						values: d("values"),
						keys: o ? v : d("keys"),
						entries: d("entries")
					}, a)
					for (u in c) !ja && !l && u in h || X(h, u, c[u]);
				else Ie({
					target: t,
					proto: 1,
					forced: ja || l
		...
		Ga = Q.set,
		Ba = Q.getterFor("Array Iterator"),
		Ha = Fa(Array, "Array", function(e, t) {
			Ga(this, {
				type: "Array Iterator",
				target: y(e),
				index: 0,
	...
	Pa.Arguments = Pa.Array, Ia("keys"), Ia("values"), Ia("entries");
	var za = !c(function() {
		...
		Ja = t(function(e) {
			var t = O.f,
				...
				a = e.exports = {
					...
					onFreeze: function(e) {
						return za && a.REQUIRED && i(e) && !C(e, n) && o(e), e
					}
				};
			z[n] = 1
		}),
		Wa = (Ja.REQUIRED, Ja.fastKey, Ja.getWeakData, Ja.onFreeze, Le("iterator")),
		qa = Array.prototype,
		Ka = Le("iterator"),
		$a = function(e, t, n, r) {
			try {
		...
		Ya = t(function(e) {
			...
			(e.exports = function(e, n, r, i, o) {
				var a, s, c, u, d, p, l, f = Je(n, r, i ? 2 : 1);
				if (o) a = e;
				else {
					if ("function" != typeof(s = function(e) {
							if (null != e) return e[Ka] || e["@@iterator"] || Pa[gr(e)]
						}(e))) throw TypeError("Target is not iterable");
					if (void 0 !== (l = s) && (Pa.Array === l || qa[Wa] === l)) {
						for (c = 0, u = ae(e.length); u > c; c++)
							if ((d = i ? f(x(p = e[c])[0], p[1]) : f(e[c])) && d instanceof t) return d;
						return new t(0)
					}
					a = s.call(e)
				}
				for (; !(p = a.next()).done;)
					if ((d = $a(a, f, p.value, i)) && d instanceof t) return d;
				return new t(0)
			}).stop = function(e) {
				return new t(1, e)
			}
	...
	var ns = function(e, t) {
		...
		rs = function(e, t, n) {
			var r, i;
			return La && "function" == typeof(r = t.constructor) && r !== n && S(i = r.prototype) && i !== n.prototype && La(e,
				i), e
		},
		is = function(e, t, n) {
		...
		ps = (function(e, t, n, r, i) {
			...
			if (we(e, "function" != typeof o || !(i || a.forEach && !c(function() {
					(new o).entries().next()
				})))) u = n.getConstructor(t, e, r, d), Ja.REQUIRED = 1;
			else if (we(e, 1)) {
				var f = new u,
					h = f[d](i ? {} : -0, 1) != f,
					m = c(function() {
				...
				v || ((u = t(function(t, n) {
						Qa(t, u, e);
						var i = rs(new o, t, u);
						return null != n && Ya(n, i[d], i, r), i
					})).prototype = a, a.constructor = u), (m || g) && (l("delete"), l("has"), r && l("get")), (g || h) && l(d), i &&
					a.clear && delete a.clear
			}
			p[e] = u, Ie({
				global: 1,
				forced: u != o
			}, p), jo(u, e), i || n.setStrong(u, e, r)
		}("Map", function(e) {
			return function() {
			...
			getConstructor: function(e, t, n, r) {
				var i = e(function(e, o) {
						Qa(e, i, t), us(e, {
							...
							last: void 0,
							size: 0
						}), u || (e.size = 0), null != o && Ya(o, e[r], e, n)
					}),
					o = ds(t),
					a = function(e, t, n) {
						var r, i, a = o(e),
				...
				return is(i.prototype, {
					...
					forEach: function(e) {
						for (var t, n = o(this), r = Je(e, arguments.length > 1 ? arguments[1] : void 0, 3); t = t ? t.next : n.first;)
		...
		ms = function(e) {
			return function(t) {
				var n = String(_(t));
				return 1 & e && (n = n.replace(fs, "")), 2 & e && (n = n.replace(hs, "")), n
			}
		},
		vs = {
			start: ms(1),
		...
		Ts = function(e) {
			...
			if ("string" == typeof u && u.length > 2)
				if (43 === (t = (u = Ss(u)).charCodeAt(0)) || 45 === t) {
	...
	if (we("Number", !bs(" 0o1") || !bs("0b1") || bs("+0x1"))) {
		for (var Rs, ws = function(e) {
					var t = arguments.length < 1 ? 0 : e,
						n = this;
					return n instanceof ws && (Cs ? c(function() {
						ks.valueOf.call(n)
					}) : "Number" != m(n)) ? rs(new bs(Ts(t)), n, ws) : Ts(t)
				}, Es = u ? gs(bs) :
				...
				.split(","), Is = 0; Es.length > Is; Is++) C(bs, Rs = Es[Is]) && !C(ws, Rs) && ys(ws, Rs, _s(bs, Rs));
		ws.prototype = ks, ks.constructor = ws, X(s, "Number", ws)
	}
	var Ps = Math.floor;
	Ie({
		target: "Number",
		...
		isInteger: function(e) {
			return !S(e) && isFinite(e) && Ps(e) === e
		}
	});
	var xs, As, Os, Ds = s.location,
		Ns = s.setImmediate,
		Ls = s.clearImmediate,
		Ms = s.process,
		js = s.MessageChannel,
		...
		zs = function(e) {
			s.postMessage(e + "", Ds.protocol + "//" + Ds.host)
		};
	Ns && Ls || (Ns = function(e) {
			for (var t = [], n = 1; arguments.length > n;) t.push(arguments[n++]);
			return Fs[++Us] = function() {
				("function" == typeof e ? e : Function(e)).apply(void 0, t)
			}, xs(Us), Us
		}, Ls = function(e) {
			delete Fs[e]
		}, "process" == m(Ms) ? xs = function(e) {
			Ms.nextTick(Bs(e))
		} : Vs && Vs.now ? xs = function(e) {
			Vs.now(Bs(e))
		} : js ? (Os = (As = new js).port2, As.port1.onmessage = Hs, xs = Je(Os.postMessage, Os, 1)) : !s.addEventListener ||
		"function" != typeof postMessage || s.importScripts || c(zs) ? xs = "onreadystatechange" in w("script") ? function(
			e) {
			Co.appendChild(w("script")).onreadystatechange = function() {
				Co.removeChild(this), Gs(e)
			}
		} : function(e) {
			setTimeout(Bs(e), 0)
		} : (xs = zs, s.addEventListener("message", Hs, 0)));
	var Js, Ws, qs, Ks, $s, Ys, Qs, Xs = {
			set: Ns,
			clear: Ls
		},
		Zs = te("navigator", "userAgent") || "",
		ec = P.f,
		tc = Xs.set,
		nc = s.MutationObserver || s.WebKitMutationObserver,
		rc = s.process,
		ic = s.Promise,
		oc = "process" == m(rc),
		ac = ec(s, "queueMicrotask"),
		sc = ac && ac.value;
	sc || (Js = function() {
		var e, t;
		for (oc && (e = rc.domain) && e.exit(); Ws;) {
			t = Ws.fn, Ws = Ws.next;
			try {
				t()
			} catch (nl) {
				throw Ws ? Ks() : qs = void 0, nl
			}
		}
		qs = void 0, e && e.enter()
	}, oc ? Ks = function() {
		rc.nextTick(Js)
	} : nc && !/(iphone|ipod|ipad).*applewebkit/i.test(Zs) ? ($s = 1, Ys = document.createTextNode(""), new nc(Js).observe(
		Ys, {
			characterData: 1
		}), Ks = function() {
		Ys.data = $s = !$s
	}) : ic && ic.resolve ? (Qs = ic.resolve(void 0), Ks = function() {
		Qs.then(Js)
	}) : Ks = function() {
		tc.call(s, Js)
	});
	var cc, uc, dc, pc = sc || function(e) {
			var t = {
				fn: e,
				next: void 0
			};
			qs && (qs.next = t), Ws || (Ws = t, Ks()), qs = t
		},
		lc = function(e) {
			var t, n;
		...
		xc = Pc,
		Ac = "process" == m(Rc),
		Oc = !!(Tc && Tc.createEvent && s.dispatchEvent),
		Dc = we(_c, function() {
			var e = kc.resolve(1),
				t = function() {},
				n = (e.constructor = {})[gc] = function(e) {
					e(t, t)
				};
			return !((Ac || "function" == typeof PromiseRejectionEvent) && e.then(t) instanceof n && 0 !== Ic.indexOf("6.6") &&
				-1 === Zs.indexOf("Chrome/66"))
		}),
		Nc = Dc || !ns(function(e) {
				...
				pc(function() {
					for (var i = t.value, o = 1 == t.state, a = 0; r.length > a;) {
						var s, c, u, d = r[a++],
							...
							h = d.domain;
						try {
							p ? (o || (2 === t.rejection && Fc(e, t), t.rejection = 1), 1 == p ? s = i : (h && h.enter(), s = p(i), h &&
									(h.exit(), u = 1)), s === d.promise ? f(Cc("Promise-chain cycle")) : (c = Lc(s)) ? c.call(s, l, f) : l(s)) :
								f(i)
						} catch (nl) {
							h && !u && h.exit(), f(nl)
						}
					}
					t.reactions = [], t.notified = 0, n && !t.rejection && Vc(e, t)
				})
			}
		},
		jc = function(e, t, n) {
			var r, i;
			Oc ? ((r = Tc.createEvent("Event")).promise = t, r.reason = n, r.initEvent(e, 0, 1), s.dispatchEvent(r)) : r = {
				promise: t,
				reason: n
		...
		Vc = function(e, t) {
			vc.call(s, function() {
				var n, r = t.value;
				if (Uc(t) && (n = mc(function() {
						Ac ? Rc.emit("unhandledRejection", r, e) : jc("unhandledrejection", e, r)
					}), t.rejection = Ac || Uc(t) ? 2 : 1, n.error)) throw n.value
			})
		},
		Uc = function(e) {
		...
		Fc = function(e, t) {
			vc.call(s, function() {
				Ac ? Rc.emit("rejectionHandled", e) : jc("rejectionhandled", e, t.value)
			})
		},
		Gc = function(e, t, n, r) {
			return function(i) {
		...
		Bc = function(e, t, n, r) {
			t.done || (t.done = 1, r && (t = r), t.value = n, t.state = 2, Mc(e, t, 1))
		},
		Hc = function(e, t, n, r) {
			if (!t.done) {
				t.done = 1, r && (t = r);
				try {
					if (e === n) throw Cc("Promise can't be resolved itself");
					var i = Lc(n);
					i ? pc(function() {
						var r = {
							done: 0
						...
						try {
							i.call(n, Gc(Hc, e, r, t), Gc(Bc, e, r, t))
						} catch (nl) {
							Bc(e, r, nl, t)
						}
					}) : (t.value = n, t.state = 1, Mc(e, t, 0))
				} catch (nl) {
					Bc(e, {
						done: 0
					}, nl, t)
	...
	Dc && (kc = function(e) {
		Qa(this, kc, _c), ze(e), cc.call(this);
		var t = yc(this);
		try {
			e(Gc(Hc, this, t), Gc(Bc, this, t))
		} catch (nl) {
			Bc(this, t, nl)
		}
	}, (cc = function(e) {
	...
	}).prototype = is(kc.prototype, {
		then: function(e, t) {
			var n = bc(this),
				r = Pc(Br(this, kc));
			return r.ok = "function" == typeof e ? e : 1, r.fail = "function" == typeof t && t, r.domain = Ac ? Rc.domain :
				void 0, n.parent = 1, n.reactions.push(r), 0 != n.state && Mc(this, n, 0), r.promise
		},
		catch: function(e) {
		...
		var e = new cc,
			t = yc(e);
		this.promise = e, this.resolve = Gc(Hc, e, t), this.reject = Gc(Bc, e, t)
	}, fc.f = Pc = function(e) {
		return e === kc || e === dc ? new uc(e) : xc(e)
	}, "function" == typeof wc && Ie({
		global: 1,
		enumerable: 1,
		forced: 1
	}, {
		fetch: function(e) {
			return hc(kc, wc.apply(s, arguments))
		}
	})), Ie({
		global: 1,
		wrap: 1,
		...
		Promise: kc
	}), jo(kc, _c, 0), as(_c), dc = Z.Promise, Ie({
		target: _c,
		stat: 1,
		forced: Dc
	}, {
	...
	var zc = xr.charAt,
		Jc = Q.set,
		Wc = Q.getterFor("String Iterator");
	...
	Ie({
		...
		startsWith: function(e) {
			var t = String(_(this));
			qc(e);
			var n = ae(Yc(arguments.length > 1 ? arguments[1] : void 0, t.length)),
				r = String(e);
		...
		du = function(e) {
			return function(t, n) {
				var r = arguments.length > 2,
					i = r ? cu.call(arguments, 2) : void 0;
				return e(r ? function() {
	...
	Ie({
		...
		setTimeout: du(s.setTimeout),
		setInterval: du(s.setInterval)
	});
	var pu = c(function() {
		bo(1)
	});
	...
	var lu = l.f,
		fu = function(e) {
			return function(t) {
				for (var n, r = y(t), i = bo(r), o = i.length, a = 0, s = []; o > a;) n = i[a++], u && !lu.call(r, n) || s.push(e ?
					[n, r[n]] : r[n]);
				return s
			}
		},
	...
	function gu(e) {
		...
		if (e.toString == vu) switch (e.toString()) {
			case "[object File]":
			case "[object Map]":
			case "[object Set]":
				return 0 === e.size;
	...
	var _u = t(function(e) {
			...
			Object.create && (r.prototype = Object.create(null), (new r).__proto__ || (n = 0)), s.prototype.eventNames =
				function() {
					...
					var c, u, d = this._events[s],
						p = arguments.length;
					if (d.fn) {
						switch (d.once && this.removeListener(e, d.fn, void 0, 1), p) {
							case 1:
						...
						var l, f = d.length;
						for (u = 0; u < f; u++) switch (d[u].once && this.removeListener(e, d[u].fn, void 0, 1), p) {
							case 1:
		...
		Tu = "on_peer_sdp",
		Ru = "on_reexchange_sdp",
		wu = "on_peer_candidate",
		Eu = "on_create_room",
		Iu = "on_close_peer",
		Pu = "on_quality_report",
		xu = "on_rebuild_session",
		Au = "on_change_av_state",
		Ou = "on_subscribe",
		Du = "on_constraints_config",
		...
		ju = function(e) {
			eo.post("https://yun.tim.qq.com/v5/AVQualityReportSvc/C2S?sdkappid=1&cmdtype=jssdk_event", JSON.stringify(e)).then(
		...
		Uu = function() {
			function e(t) {
				et(this, e), this.sdkAppId_ = t.sdkAppId, this.userId_ = t.userId, this.userSig_ = t.userSig, this.url_ = t.url,
					...
					.concat(this.userSig_), this.isConnected_ = 0, this.isConnecting_ = 0, this.tryCount_ = Vu, this.socketInUse_ =
					null, this.socket_ = null, this.backupSocket_ = null, this.backupTimer_ = -1, this.reconnectTimer_ = -1, this.signalInfo_ = {},
					this.currentState_ = bu.DISCONNECTED, this.emitter_ = new _u
			}
			return nt(e, [{
				key: "connect",
				value: function() {
					var e = this;
					Hn.info("connect to url: ".concat(this.urlWithParam_)), this.emitter_.emit(yu, {
						prevState: this.currentState_,
						state: bu.CONNECTING
					}), this.currentState_ = bu.CONNECTING, this.socket_ = new WebSocket(this.urlWithParam_), this.bindSocket(
				...
				value: function(e) {
					if (!this.isConnected_) {
						...
						var t = e.target.url;
						Hn.info("[".concat(this.userId_, "] websocket[").concat(t, "] is connected")), this.emitter_.emit(yu, {
							prevState: this.currentState_,
							state: bu.CONNECTED
						}), this.currentState_ = bu.CONNECTED
					}
				}
			}, {
				key: "onclose",
				value: function(e) {
					...
					Hn.info("[".concat(this.userId_, "] websocket[").concat(t, " InUse: ").concat(n, "] is closed with code: ").concat(
						...
						e.code ? (Hn.warn("[".concat(this.userId_, "] onclose code:").concat(e.code, " reason:").concat(e.reason)),
							this.isConnecting_ && this.tryCount_ <= 0 ? (this.isConnecting_ = 0, this.tryCount_ = Vu, Hn.error("[".concat(
								this.userId_, "] reconnect failed")), this.emitter_.emit(yu, {
								prevState: this.currentState_,
								state: bu.DISCONNECTED
							}), this.currentState_ = bu.DISCONNECTED, ju({
								eventType: "websocketReconnectionState",
								result: "failed"
							}), this.emitter_.emit(Su, new Mu({
								code: Lu.SIGNAL_CHANNEL_ERROR,
								...
								null, this.reconnect(t))) : (this.emitter_.emit(yu, {
							prevState: this.currentState_,
							state: bu.DISCONNECTED
						}), this.currentState_ = bu.DISCONNECTED))
				}
			}, {
				key: "onerror",
				value: function(e) {
					...
					Hn.error("[".concat(this.userId_, "] websocket[").concat(t, "] error observed")), this.isConnected_ ? e.target ===
						this.socketInUse_ && (this.isConnected_ = 0, this.unbindAndCloseSocket("main"), this.unbindAndCloseSocket(
							"backup"), this.socketInUse_ = null, this.emitter_.emit(Su, new Mu({
							code: Lu.SIGNAL_CHANNEL_ERROR,
							...
							"backup"), null === this.socket_ && null === this.backupSocket_ && (this.isConnecting_ ? ju({
							eventType: "websocketReconnectionState",
							result: "failed"
						}) : ju({
							eventType: "websocketConnectionState",
							result: "failed"
						}), Hn.error("SignalChannel setup failed"), this.emitter_.emit(Su, new Mu({
							code: Lu.SIGNAL_CHANNEL_ERROR,
				...
				value: function(e) {
					...
					if (this.isConnected_) {
						var n = JSON.parse(e.data),
							...
							i = n.content,
							o = Object.values(ku),
							a = Object.keys(ku)[o.indexOf(r)],
							s = Cu[a];
						if (r !== ku.UPDATE_REMOTE_MUTE_STAT) {
						...
						switch (r) {
							case ku.CHANNEL_SETUP_SUCCESS:
								this.signalInfo_.relayIp = i.relayip, this.signalInfo_.relayInnerIp = i.innerip, this.signalInfo_.signalIp =
									...
									.emit(Cu.REQUEST_REBUILD_SESSION, {
										signalInfo: this.signalInfo_
									}) : this.emitter_.emit(s, {
										signalInfo: this.signalInfo_
									});
								break;
							case ku.CHANNEL_SETUP_FAILED:
								var u = "sdkAppId invalid",
									d = "";
								void 0 !== i.errorCode && (u = i.errorCode, d = i.errorMsg), this.emitter_.emit(Su, new Mu({
									code: Lu.CHANNEL_SETUP_FAILED,
				...
				value: function(e) {
					...
					this.reconnectTimer_ = setTimeout(function() {
						...
						var n = e;
						gu(t.signalInfo_) || (n = e + "&iip=" + t.signalInfo_.relayInnerIp + "&dp=" + t.signalInfo_.dataPort +
							"&oip=" + t.signalInfo_.relayIp + "&sp=" + t.signalInfo_.stunPort + "&rc=1"), t.emitter_.emit(yu, {
							prevState: t.currentState_,
							state: bu.RECONNECTING
						}), t.currentState_ = bu.RECONNECTING, t.socket_ = new WebSocket(n), t.bindSocket(t.socket_)
					}, 3e3)
				}
			}, {
				key: "send",
		...
		Fu = vs.trim,
		Gu = s.parseFloat,
		Bu = 1 / Gu(ps + "-0") != -Infinity ? function(e) {
			var t = Fu(String(e)),
				n = Gu(t);
	...
	var Hu, zu, Ju = window.navigator && window.navigator.userAgent || "",
		Wu = /AppleWebKit\/([\d.]+)/i.exec(Ju),
		qu = (Wu && parseFloat(Wu.pop()), /iPad/i.test(Ju)),
		Ku = /iPhone/i.test(Ju) && !qu,
		$u = /iPod/i.test(Ju),
		Yu = Ku || qu || $u,
		Qu = ((Hu = Ju.match(/OS (\d+)_/i)) && Hu[1] && Hu[1], /Android/i.test(Ju)),
		Xu = function() {
			var e = Ju.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i);
			if (!e) return null;
			var t = e[1] && parseFloat(e[1]),
				n = e[2] && parseFloat(e[2]);
			return t && n ? parseFloat(e[1] + "." + e[2]) : t || null
		}(),
		Zu = (Qu && /webkit/i.test(Ju), /Firefox/i.test(Ju)),
		ed = /Edge/i.test(Ju),
		td = !ed && /Chrome/i.test(Ju),
		nd = (function() {
			var e = Ju.match(/Chrome\/(\d+)/);
			e && e[1] && parseFloat(e[1])
		}(), function() {
			var e = Ju.match(/Chrome\/([\d.]+)/);
			return e && e[1] ? e[1] : null
		}()),
		rd = (/MSIE\s8\.0/.test(Ju), function() {
			var e = /MSIE\s(\d+)\.\d/.exec(Ju),
				t = e && parseFloat(e[1]);
			!t && /Trident\/7.0/i.test(Ju) && /rv:11.0/.test(Ju) && (t = 11)
		}(), /Safari/i.test(Ju) && !td && !Qu && !ed),
		id = function() {
			var e = Ju.match(/Version\/([\d.]+)/);
			return e && e[1] ? e[1] : null
		}(),
		od = /TBS\/\d+/i.test(Ju),
		ad = (function() {
				var e = Ju.match(/TBS\/(\d+)/i);
				if (e && e[1]) e[1]
			}(), !od && /MQQBrowser\/\d+/i.test(Ju), !od && / QQBrowser\/\d+/i.test(Ju), /(micromessenger|webbrowser)/i.test(Ju),
			/Windows/i.test(Ju), /MAC OS X/i.test(Ju), /MicroMessenger/i.test(Ju), td ? "Chrome/" + nd : rd ? "Safari/" + id :
			"NotSupportedBrowser");
	window.addEventListener("message", function(e) {
		e.origin == window.location.origin && function(e) {
			if ("PermissionDeniedError" == e) {
				if (zu) return zu("PermissionDeniedError");
				throw new Error("PermissionDeniedError")
			}
			e.sourceId && zu && zu(e.sourceId, 1 == e.canRequestAudioTrack)
		}(e.data)
	});
	window.InstallTrigger;
	var sd = !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0,
		cd = (window.chrome, function() {
			var e = 0;
		...
		fd = 20,
		hd = 21,
		md = "5Y2wZK8nANNAoVw6dSAHVjNxrD1ObBM2kBPV",
		vd = "224d130c-7b5c-415b-aaa2-79c2eb5a6df2",
		gd = 2,
		_d = 7,
		yd = Ke.find,
		Sd = 1;
	...
	var bd = O.f,
		...
		Ed = /a/g,
		Id = new Td(wd) !== wd;
	if (u && we("RegExp", !Id || c(function() {
			return Ed[Cd] = 0, Td(wd) != wd || Td(Ed) == Ed || "/a/i" != Td(wd, "i")
		}))) {
		for (var Pd = function(e, t) {
				var n = this instanceof Pd,
					r = Fr(e),
					i = void 0 === t;
				return !n && r && e.constructor === Pd && i ? e : rs(Id ? new Td(r && !i ? e.source : e, t) : Td((r = e instanceof Pd) ?
					e.source : e, r && i ? Mn.call(e) : t), n ? this : Rd, Pd)
			}, xd = function(e) {
				e in Pd || bd(Pd, e, {
					configurable: 1,
					get: function() {
			...
			}, Ad = kd(Td), Od = 0; Ad.length > Od;) xd(Ad[Od++]);
		Rd.constructor = Pd, Pd.prototype = Rd, X(s, "RegExp", Pd)
	}
	as("RegExp");
	var Dd = function() {
		...
		Md = "stream-updated",
		jd = "stream-published",
		Vd = "stream-subscribed",
		Ud = "stream-unsubscribed",
		Fd = "error",
		Gd = "stream-added",
		Bd = "stream-removed",
		Hd = "stream-updated",
		zd = "stream-subscribed",
		Jd = "connection-state-changed",
		Wd = "peer-join",
		qd = "peer-leave",
		Kd = "mute-audio",
		$d = "mute-video",
		...
		tp = "screen-sharing-stopped",
		np = "player-state-changed",
		rp = 1..toFixed,
		ip = Math.floor,
		op = function(e, t, n) {
			return 0 === t ? n : t % 2 == 1 ? op(e, t - 1, n * e) : op(e * e, t / 2, n)
		},
		ap = rp && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) ||
	...
	Ie({
		...
		toFixed: function(e) {
			var t, n, r, i, o = function(e) {
				...
				u = "0",
				d = function(e, t) {
					for (var n = -1, r = t; ++n < 6;) r += e * s[n], s[n] = r % 1e7, r = ip(r / 1e7)
				},
				p = function(e) {
					for (var t = 6, n = 0; --t >= 0;) n += s[t], s[t] = ip(n / e), n = n % e * 1e7
				},
				l = function() {
					for (var e = 6, t = ""; --e >= 0;)
						if ("" !== t || 0 === e || 0 !== s[e]) {
			...
			if (o < 0 && (c = "-", o = -o), o > 1e-21)
				if (n = (t = function(e) {
						...
						for (; n >= 2;) t += 1, n /= 2;
						return t
					}(o * op(2, 69, 1)) - 69) < 0 ? o * op(2, -t, 1) : o / op(2, t, 1), n *= 4503599627370496, (t = 52 - t) > 0) {
					for (d(0, n), r = a; r >= 7;) d(1e7, 0), r -= 7;
					for (d(op(10, r, 1), 0), r = t - 1; r >= 23;) p(1 << 23), r -= 23;
					p(1 << r), d(1, 1), p(2), u = l()
				} else d(0, n), d(1 << -t, 0), u = l() + Yn.call("0", a);
			return u = a > 0 ? c + ((i = u.length) <= a ? "0." + Yn.call("0", a - i) + u : u.slice(0, i - a) + "." + u.slice(
				i - a)) : c + u
		}
	});
	var sp = window.AudioContext || window.webkitAudioContext,
		cp = null,
		up = function() {
			function e() {
				var t = this;
				et(this, e), cp || (cp = new sp), this.context_ = cp, this.instant_ = 0, this.slow_ = 0, this.clip_ = 0, this.script_ =
		...
		dp = function() {
			function e(t) {
				et(this, e), this.stream_ = t.stream, this.userId_ = t.stream.getUserId(), this.track_ = t.track, this.div_ = t.div,
					this.muted_ = t.muted, this.outputDeviceId_ = t.outputDeviceId, this.volume_ = t.volume, this.element_ = null,
					this.emitter_ = new _u, this.state_ = "NONE", this.soundMeter_ = null
			}
			var t, n;
			return nt(e, [{
				key: "play",
				value: (n = Ze(regeneratorRuntime.mark(function e() {
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							...
							case 12:
								this.element_ = n, this.setVolume(this.volume_), this.handleEvents();
							case 15:
							case "end":
								return e.stop()
						}
				...
				value: function() {
					...
					this.element_.addEventListener("playing", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - audio player is starting playing")), e.state_ = "PLAYING", e.emitter_.emit(np, {
							state: e.state_,
							reason: "playing"
						})
					}), this.element_.addEventListener("ended", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - audio player is ended")), "STOPPED" !== e.state_ && (e.state_ = "STOPPED", e.emitter_.emit(np, {
							state: e.state_,
							reason: "ended"
						}))
					}), this.element_.addEventListener("pause", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - audio player is paused")), e.state_ = "PAUSED", e.emitter_.emit(np, {
							state: e.state_,
							reason: "pause"
						})
					}), this.track_.addEventListener("ended", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - audio player track is ended")), "STOPPED" !== e.state_ && (e.state_ = "STOPPED", e.emitter_.emit(
							np, {
								state: e.state_,
								reason: "ended"
							}))
						...
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - audio track is muted readyState: ").concat(e.track_.readyState)), "PAUSED" !== e.state_ && (e
							.state_ = "PAUSED", e.emitter_.emit(np, {
								state: e.state_,
								reason: "mute"
							}))
					}), this.track_.addEventListener("unmute", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
								" stream - audio track is unmuted readyState: ").concat(e.track_.readyState)), "PAUSED" === e.state_ &&
							(e.state_ = "PLAYING", e.emitter_.emit(np, {
								state: e.state_,
								reason: "unmute"
							}))
					})
				...
				key: "setVolume",
				value: function(e) {
					Hn.info("[".concat(this.userId_, "] ").concat(this.stream_.isRemote() ? this.stream_.getType() : "local",
						" stream - audioElement setVolume to : ").concat(e)), this.element_.volume = e
				}
			}, {
				key: "getAudioLevel",
				value: function() {
					return this.soundMeter_ || (this.soundMeter_ = new up, this.soundMeter_.connectToSource(this.track_)), this.soundMeter_
						.getVolume()
				}
			}, {
				key: "stop",
		...
		pp = function() {
			function e(t) {
				et(this, e), this.stream_ = t.stream, this.userId_ = t.stream.getUserId(), this.track_ = t.track, this.div_ = t.div,
					this.muted_ = t.muted, this.objectFit_ = t.objectFit, this.mirror_ = t.mirror, this.element_ = null, this.emitter_ =
					new _u, this.state_ = "NONE"
			}
			return nt(e, [{
				key: "play",
				value: function() {
					...
					t.srcObject = e, t.muted = this.muted_;
					var n = 0;
					this.mirror_ && (n = "180deg"), t.setAttribute("id", "video_".concat(this.stream_.getId())), t.setAttribute(
							"style", "width: 100%; height: 100%; position: absolute; transform: rotateY(".concat(n, "); object-fit: ").concat(
								this.objectFit_)), t.setAttribute("autoplay", "autoplay"), t.setAttribute("playsinline", "playsinline"),
						this.div_.appendChild(t), this.element_ = t, this.handleEvents()
				}
			}, {
				key: "handleEvents",
				value: function() {
					...
					this.element_.addEventListener("playing", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - video player is starting playing")), e.state_ = "PLAYING", e.emitter_.emit(np, {
							state: e.state_,
							reason: "playing"
						})
					}), this.element_.addEventListener("ended", function(t) {
						Hn.info("[".concat(e.userId_, "] i").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - video player is ended")), "STOPPED" !== e.state_ && (e.state_ = "STOPPED", e.emitter_.emit(np, {
							state: e.state_,
							reason: "ended"
						}))
					}), this.element_.addEventListener("pause", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - video player is paused")), e.state_ = "PAUSED", e.emitter_.emit(np, {
							state: e.state_,
							reason: "pause"
						})
					}), this.track_.addEventListener("ended", function(t) {
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - video player track is ended")), "STOPPED" !== e.state_ && (e.state_ = "STOPPED", e.emitter_.emit(
							np, {
								state: e.state_,
								reason: "ended"
							}))
						...
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
							" stream - video track is muted readyState: ").concat(e.track_.readyState)), "PAUSED" !== e.state_ && (e
							.state_ = "PAUSED", e.emitter_.emit(np, {
								state: e.state_,
								reason: "mute"
							}))
						...
						Hn.info("[".concat(e.userId_, "] ").concat(e.stream_.isRemote() ? e.stream_.getType() : "local",
								" stream - video track is unmuted readyState: ").concat(e.track_.readyState)), "PAUSED" === e.state_ &&
							(e.state_ = "PLAYING", e.emitter_.emit(np, {
								state: e.state_,
								reason: "unmute"
							}))
		...
		lp = function() {
			function e(t) {
				et(this, e), this.userId_ = t.userId, this.isRemote_ = t.isRemote, this.mirror_ = 0, this.isRemote_ || (this.mirror_ =
						1), void 0 !== t.mirror && (this.mirror_ = t.mirror), this.mediaStream_ = null, this.div_ = null, this.isPlaying_ =
					0, this.connection_ = null, this.hasAudio_ = 0, this.hasVideo_ = 0, this.audioPlayer_ = null, this.videoPlayer_ =
					null, this.muted_ = 0, this.objectFit_ = "cover", this.id_ = Dd(), this.audioOutputDeviceId_ = 0, this.audioVolume_ =
					1, this.emitter_ = new _u
			}
			var t, n;
			return nt(e, [{
				key: "setConnection",
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								...
								throw new Mu({
									code: Lu.INVALID_OPERATION,
									message: "duplicated play() call observed, please stop() firstly"
								});
							case 2:
								this.isPlaying_ = 1, Hn.info("playing ".concat(this.userId_, " ").concat(this.isRemote_ ? this.getType() :
										"local", " stream")), (r = document.createElement("div")).setAttribute("id", "player_".concat(this
										.id_)), r.setAttribute("style",
									...
									"auxiliary" === this.getType() && (this.objectFit_ = "contain"), n && void 0 !== n.objectFit && (
										this.objectFit_ = n.objectFit), this.hasAudio_ && this.playAudio(), this.hasVideo_ && this.playVideo();
							case 17:
							case "end":
								return e.stop()
						}
				...
				value: function() {
					...
					!this.audioPlayer_ && t && (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ? this.getType() :
						"local", " stream - create AudioPlayer and play")), this.audioPlayer_ = new dp({
						stream: this,
						track: t,
						div: this.div_,
						muted: this.muted_,
					...
					}), this.audioPlayer_.on(np, function(t) {
						e.emitter_.emit(ep, {
							type: "audio",
							state: t.state,
							reason: t.reason
				...
				value: function() {
					...
					!this.videoPlayer_ && t && (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ? this.getType() :
						"local", " stream - create VideoPlayer and play")), this.videoPlayer_ = new pp({
						stream: this,
						track: t,
						div: this.div_,
						muted: this.muted_,
						...
						mirror: this.mirror_
					}), this.videoPlayer_.on(np, function(t) {
						e.emitter_.emit(ep, {
							type: "video",
							state: t.state,
							reason: t.reason
				...
				key: "stopAudio",
				value: function() {
					this.audioPlayer_ && (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ? this.getType() : "local",
						" stream - stop AudioPlayer")), this.audioPlayer_.stop(), this.audioPlayer_ = null)
				}
			}, {
				key: "stopVideo",
				value: function() {
					this.videoPlayer_ && (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ? this.getType() : "local",
						" stream - stop VideoPlayer")), this.videoPlayer_.stop(), this.videoPlayer_ = null)
				}
			}, {
				key: "restartAudio",
				value: function() {
				...
				key: "resume",
				value: function() {
					this.isPlaying_ && (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ? this.getType() : "local",
							" stream - resume")), this.audioPlayer_ && this.audioPlayer_.resume(), this.videoPlayer_ && this.videoPlayer_
						.resume())
				}
			}, {
				key: "close",
				...
				key: "setAudioVolume",
				value: function(e) {
					this.audioVolume_ = e, Hn.info("[".concat(this.userId_, "] setAudioVolume to ").concat(e)), this.audioPlayer_ &&
						this.audioPlayer_.setVolume(e)
				}
			}, {
				key: "getAudioLevel",
				value: function() {
				...
				key: "setHasVideo",
				value: function(e) {
					this.hasVideo_ = e, this.isPlaying_ && (e ? (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ?
						this.getType() : "local", " stream updated, play video")), this.playVideo()) : (Hn.info("".concat(this.userId_,
						" ").concat(this.isRemote_ ? this.getType() : "local", " stream updated, stop video")), this.stopVideo()))
				}
			}, {
				key: "setHasAudio",
				value: function(e) {
					this.hasAudio_ = e, this.isPlaying_ && (e ? (Hn.info("".concat(this.userId_, " ").concat(this.isRemote_ ?
						this.getType() : "local", " stream updated, play audio")), this.playAudio()) : (Hn.info("".concat(this.userId_,
						" ").concat(this.isRemote_ ? this.getType() : "local", " stream updated, stop audio")), this.stopAudio()))
				}
			}, {
				key: "on",
				value: function(e, t) {
		...
		fp = function(e) {
			function t(e) {
				...
				return (n = dt(this, at(t).call(this, r))).type_ = e.type, n.isInSubscriptionCycle_ = 0, n
			}
			return ot(t, lp), nt(t, [{
				key: "getType",
				value: function() {
		...
		vp = function(e) {
			...
			return function(e) {
				e.type.toUpperCase() in hp && e.transport.toUpperCase()
			}(i), i
		},
		gp = vs.trim,
		_p = s.parseInt,
		yp = /^[+-]?0[Xx]/,
		Sp = 8 !== _p(ps + "08") || 22 !== _p(ps + "0x16") ? function(e, t) {
			var n = gp(String(e));
			return _p(n, t >>> 0 || (yp.test(n) ? 16 : 10))
		} : _p;
	Ie({
		global: 1,
		forced: parseInt != Sp
	...
	var bp = function(e) {
		...
		Tp = (Cp.v, Cp.o, Cp.s, Cp.i, Cp.u, Cp.e, Cp.p, Cp.z, Cp.r, Cp.t, Cp.c, Cp.b, Cp.m, Cp.a, t(function(e, t) {
			var n = function(e) {
		...
		Rp = (Tp.parse, Tp.parseParams, Tp.parseFmtpConfig, Tp.parsePayloads, Tp.parseRemoteCandidates, Tp.parseImageAttributes,
			Tp.parseSimulcastStreamList, /%[sdv%]/g),
		wp = function(e) {
			var t = 1,
				n = arguments,
				r = n.length;
			return e.replace(Rp, function(e) {
				if (t >= r) return e;
				var i = n[t];
				switch (t += 1, e) {
					case "%%":
		...
		Ep = function(e, t, n) {
			...
			return wp.apply(null, r)
		},
		Ip = ["v", "o", "s", "i", "u", "e", "p", "c", "b", "t", "r", "z", "a"],
		Pp = ["i", "c", "b", "a"],
		xp = {
			write: function(e, t) {
				...
				var n = t.outerOrder || Ip,
					r = t.innerOrder || Pp,
					i = [];
				return n.forEach(function(t) {
					Cp[t].forEach(function(n) {
						n.name in e && null != e[n.name] ? i.push(Ep(t, n, e)) : n.push in e && null != e[n.push] && e[n.push].forEach(
							function(e) {
								i.push(Ep(t, n, e))
							})
					})
				}), e.media.forEach(function(e) {
					i.push(Ep("m", Cp.m[0], e)), r.forEach(function(t) {
						Cp[t].forEach(function(n) {
							n.name in e && null != e[n.name] ? i.push(Ep(t, n, e)) : n.push in e && null != e[n.push] && e[n.push].forEach(
								function(e) {
									i.push(Ep(t, n, e))
			...
			parse: Tp.parse,
			parseFmtpConfig: Tp.parseFmtpConfig,
			parseParams: Tp.parseParams,
			parsePayloads: Tp.parsePayloads,
			parseRemoteCandidates: Tp.parseRemoteCandidates,
			parseImageAttributes: Tp.parseImageAttributes,
			parseSimulcastStreamList: Tp.parseSimulcastStreamList
		},
		Ap = function(e) {
			return xp.parse(e)
		},
	...
	Ir("search", 1, function(e, t, n) {
		return [function(t) {
			...
			var i = x(e),
				o = String(this),
				a = i.lastIndex;
			Dp(a, 0) || (i.lastIndex = 0);
			var s = Dr(i, o);
			return Dp(i.lastIndex, a) || (i.lastIndex = a), null === s ? -1 : s.index
		}]
	});
	var Np = function(e) {
			var t = e,
		...
		Mp = function() {
			function e(t) {
				et(this, e), this.userId_ = t.userId, this.tinyId_ = t.tinyId, this.client_ = t.client, this.sdpSemantics_ = t.client
					.getSdpSemantics(), this.iceServers_ = t.iceServers, this.isUplink_ = t.isUplink, this.signalChannel_ = t.signalChannel,
					this.peerConnection_ = null, this.connectTimer_ = -1, this.remoteStreams_ = new Map, this.localStream_ = null,
					this.iceCandidates_ = [], this.isIceCandidateSent_ = 0, this.isSdpExchanged_ = 0, this.waitForUpdatedAnswer_ = 0,
					this.mutedState_ = 0, this.subscribeState_ = {
						audio: 1,
						video: 1,
						auxiliary: 1
					}, this.pendingSubscription_ = [], this.pendingStreams_ = [], this.subscriptionTimeout_ = -1, this.subscriptionRetryCount_ =
					0, this.isSubscriptionPending_ = 0, this.sentSubscriptionAfterConnected_ = 0, this.emitter_ = new _u
			}
			var t, n, r, i, o, a;
			return nt(e, [{
				key: "initialize",
				...
				value: function(e, t) {
					...
					Hn.info("[".concat(this.userId_, "] is publishing stream: ").concat(e.getId())), r.getTracks().forEach(
						function(e) {
				...
				value: function(e) {
					...
					"getSettings" in MediaStreamTrack.prototype ? e.getTracks().forEach(function(e) {
						...
						}) : n = this.getMediaSettingsFromProfile(n), Hn.info("updateMediaSettings: " + JSON.stringify(n)), this.signalChannel_
						.send(Du, n)
				}
			}, {
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								...
								return Hn.info("".concat(this.userId_, " is adding ").concat(t.kind,
										" track to current published local stream")), n = this.localStream_.getMediaStream(), this.peerConnection_
									.addTrack(t, n), this.updateMediaSettings(n), e.next = 7, this.updateOffer();
							case 7:
							case "end":
								return e.stop()
						}
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								...
								if (Hn.info("".concat(this.userId_, " is removing ").concat(t.kind,
										" track from current published local stream")), !(n = this.peerConnection_.getSenders().find(
										function(e) {
											return e.track === t
										}))) {
									e.next = 8;
						...
						for (;;) switch (e.prev = e.next) {
							...
							case 7:
								n.forEach(function(e) {
									e.track && e.track.kind === t.kind && (Hn.info("".concat(r.userId_, " is replacing ").concat(t.kind,
				...
				value: function() {
					var e = this;
					Hn.info("closing [".concat(this.userId_, "]'s connection")), -1 !== this.connectTimer_ && (clearTimeout(this.connectTimer_),
						this.connectTimer_ = -1), -1 !== this.subscriptionTimeout_ && (clearTimeout(this.subscriptionTimeout_),
						this.subscriptionTimeout_ = -1), this.peerConnection_ && (this.peerConnection_.close(), this.peerConnection_ =
						null), this.isUplink_ || (this.remoteStreams_.forEach(function(t, n, r) {
						var i = t;
						i.setConnection(null), e.emitter_.emit(Ld, {
							stream: i
						})
				...
				value: function() {
					this.isUplink_ && this.signalChannel_.on(Cu.NEW_REMOTE_SDP, this.onNewRemoteSdp, this), this.signalChannel_.on(
						Cu.NEW_ICE_CANDIDATE, this.onNewIceCandidate, this), this.isUplink_ || (this.signalChannel_.on(Cu.UPDATE_REMOTE_SDP,
							this.onUpdateRemoteSdp, this), this.signalChannel_.on(Cu.UPDATE_AUDIO_SSRC, this.onUpdateAudioSSRC, this),
						this.signalChannel_.on(Cu.UPDATE_VIDEO_SSRC, this.onUpdateVideoSSRC, this), this.signalChannel_.on(Cu.SUBSCRIBE_ACK,
							this.onSubscription, this))
				}
			}, {
				key: "uninstallSignalChannelEvents",
				value: function() {
					this.isUplink_ && this.signalChannel_.removeListener(Cu.NEW_REMOTE_SDP, this.onNewRemoteSdp, this), this.signalChannel_
						.removeListener(Cu.NEW_ICE_CANDIDATE, this.onNewIceCandidate, this), this.isUplink_ || (this.signalChannel_.removeListener(
							Cu.UPDATE_REMOTE_SDP, this.onUpdateRemoteSdp, this), this.signalChannel_.removeListener(Cu.UPDATE_AUDIO_SSRC,
							this.onUpdateAudioSSRC, this), this.signalChannel_.removeListener(Cu.UPDATE_VIDEO_SSRC, this.onUpdateVideoSSRC,
							this), this.signalChannel_.removeListener(Cu.SUBSCRIBE_ACK, this.onSubscription, this))
				}
			}, {
				key: "onNewRemoteSdp",
				value: function(e) {
				...
				value: function(e) {
					...
					if (this.hitTest(t.srctinyid)) {
						Hn.info("remote user [".concat(this.userId_, "] is updating sdp offer"));
						var n = t.newSdp;
				...
				value: function(e) {
					var t = e.data.content;
					if (this.hitTest(t.srctinyid)) {
						Hn.info("remote user [".concat(this.userId_, "] is updating audio ssrc via sdp offer"));
						var n = t.newSdp;
						this.updateRemoteDescription(n)
					}
				}
				...
				value: function(e) {
					var t = e.data.content;
					if (this.hitTest(t.srctinyid)) {
						Hn.info("remote user [".concat(this.userId_, "] is updating video ssrc via sdp offer"));
						var n = t.newSdp;
						this.updateRemoteDescription(n)
					}
				}
				...
				value: function(e) {
					var t = e.streams[0],
						n = e.track;
					if (Hn.info("[".concat(this.userId_, "] ontrack: kind: ").concat(n.kind, " id: ").concat(n.id, " streamId: ")
							.concat(t.id)), "unified-plan" === this.sdpSemantics_) {
						var r = function(e) {
							var t = xp.parse(e),
								n = {
									audio: [],
							...
							return t.media.forEach(function(e) {
								if (e.ssrcs) {
									...
									if ("audio" === e.type) n.audio.push(md);
						...
						if ("audio" === n.kind) {
							if (0 === r.audio.length || t.id !== md) return void Hn.debug("skip this invalid audio track")
						} else if (-1 === r.video.indexOf(t.id)) return void Hn.debug("skip this invalid video track: " + n.id +
							" msid: " + t.id)
					}
					ju({
						eventType: "ontrack",
						...
						for (;;) switch (e.prev = e.next) {
							...
							case 2:
								void 0 === n && (n = "video"), this.isRtpSenderAvailable() && (r = this.peerConnection_.getSenders()
									...
									Hn.debug(n + " bandwidth was set to " + t + " kbps")
								}).catch(function(e) {
									return Hn.error("failed to set bandwidth: " + e)
								}));
							case 4:
							case "end":
								return e.stop()
				...
				value: function(e) {
					var t = this;
					this.peerConnection_.createOffer(Lp).then(function(e) {
						return t.peerConnection_.setLocalDescription(e)
					}).then(function() {
						Hn.info("".concat(t.userId_, " createOffer success, sending offer to remote server"));
						var e = t.peerConnection_.localDescription;
						Hn.debug("sending sdp offer: " + e.sdp), t.signalChannel_.send(Tu, e, 0), ju({
						...
						ju({
							...
							kind: "offer",
							result: "failed"
						}), Hn.error("".concat(t.userId, " failed to create offer")), e(new Mu({
							code: Lu.CREATE_OFFER_FAILED,
				...
				value: (t = Ze(regeneratorRuntime.mark(function e() {
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								return t = "", e.prev = 1, e.next = 4, this.peerConnection_.createOffer(Lp);
							case 4:
								return t = e.sent, e.next = 7, this.peerConnection_.setLocalDescription(t);
							case 7:
								n = this.peerConnection_.localDescription, Hn.info("".concat(this.userId_,
										" createOffer success, sending updated offer to remote server")), Hn.debug("updatedOffer: " + n.sdp),
									this.signalChannel_.send(Ru, n, 0), this.waitForUpdatedAnswer_ = 1, ju({
										eventType: "setLocalDescription",
										kind: "offer",
										result: "success"
									}), e.next = 20;
								break;
							case 15:
								throw e.prev = 15, e.t0 = e.catch(1), ju({
									eventType: "setLocalDescription",
									kind: "offer",
									result: "failed"
								}), Hn.error("failed to create updated sdp offer"), new Mu({
									code: Lu.CREATE_OFFER_FAILED,
				...
				value: function(e) {
					...
					this.peerConnection_.setRemoteDescription(o).then(function() {
						Hn.debug("accepted anwswer: " + r), t.setBandwidth(i, "audio"), t.setBandwidth(n, "video"), t.waitForUpdatedAnswer_ ||
							(Hn.info("".concat(t.userId_, " accepted remote answer, fired stream-published event")), t.emitter_.emit(
								jd, {
									stream: t.localStream_
								}), t.isSdpExchanged_ = 1, t.sendIceCandidate()), t.waitForUpdatedAnswer_ && (t.waitForUpdatedAnswer_ =
								0, Hn.info("got updated answer")), ju({
						...
						ju({
							...
							kind: "answer",
							result: "failed"
						}), Hn.error("".concat(t.userId_, " failed to accept remote answer ") + e)
					})
				}
			}, {
				key: "onIceCandidate",
				value: function(e) {
					if (e.candidate) {
						var t, n, r, i, o, a, s, c, u, d, p = e.candidate;
						if (Hn.info("[" + this.userId_ + "] onIceCandidate: sdpMLineIndex: " + p.sdpMLineIndex + " sdpMid: " + p.sdpMid +
								" candidate: " + p.candidate), p.candidate) {
							var l = vp(p.candidate);
							!l || l.transport !== mp.UDP || l.type !== hp.SRFLX && (l.type !== hp.HOST || (t = l.localIP, n = bp(t), r =
								bp("10.0.0.0"), i = bp("10.255.255.255"), o = bp("172.16.0.0"), a = bp("172.31.255.255"), s = bp(
									"192.168.0.0"), c = bp("192.168.255.255"), u = bp("127.0.0.0"), d = bp("127.255.255.255"), kp(n, r, i) ||
								kp(n, o, a) || kp(n, s, c) || kp(n, u, d))) || (this.iceCandidates_.push({
								candidate: p,
								type: l.type
							}), this.sendIceCandidate())
						}
					} else if (Hn.debug("[" + this.userId_ + "] onIceCandidate ended"), 0 === this.iceCandidates_.length) {
						var f = "no valid ice candidate found";
						ju({
							eventType: "getIceCandidate",
							result: "failed"
						}), Hn.error(f), this.emitter_.emit(Fd, new Mu({
							message: f,
							code: Lu.ICE_TRANSPORT_ERROR
						}))
				...
				value: function(e) {
					if (!this.isIceCandidateSent_ && this.isSdpExchanged_) {
						var t = this.findCandidate(hp.SRFLX);
						if (t) {
							Hn.info("[" + this.userId_ + "] send ice-candidate to remote server: " + t.candidate);
							var n = this.isUplink_ ? 0 : this.tinyId_;
							this.signalChannel_.send(wu, t, n), this.isIceCandidateSent_ = 1, ju({
								eventType: "getIceCandidate",
								result: "success"
							})
						}
						if (e && !this.isIceCandidateSent_ && (t = this.findCandidate(hp.HOST))) {
							Hn.info("[" + this.userId_ + "] send ice-candidate to remote server: " + t.candidate);
							var r = this.isUplink_ ? 0 : this.tinyId_;
							this.signalChannel_.send(wu, t, r), this.isIceCandidateSent_ = 1, ju({
								eventType: "getIceCandidate",
								result: "success"
							})
						}
				...
				value: function(e) {
					Hn.info("[" + this.userId_ + "] IceConnectionStateChange iceConnectionState: " + e.target.iceConnectionState +
				...
				value: function(e) {
					var t = this;
					if (Hn.info("[" + this.userId_ + "] ConnectionStateChange connectionState: " + e.target.connectionState),
						"connecting" === e.target.connectionState) {
						this.connectTimer_ = setTimeout(function() {
							var e = "[".concat(t.userId_, "] DTLS Transport connection timeout (").concat(10, "s)");
							ju({
								eventType: "iceConnectionState",
								result: "failed"
							}), Hn.error(e), t.emitter_.emit(Fd, new Mu({
								message: e,
								code: Lu.ICE_TRANSPORT_ERROR
							}))
						}, 1e4)
					...
					if ("failed" === e.target.connectionState) {
						var n = "[".concat(this.userId_, "] ICE/DTLS Transport connection failed");
						ju({
							eventType: "iceConnectionState",
							result: "failed"
						}), Hn.error(n), this.emitter_.emit(Fd, new Mu({
							message: n,
							code: Lu.ICE_TRANSPORT_ERROR
						}))
					}
					if (("connected" === e.target.connectionState || "completed" === e.target.connectionState) && (ju({
							eventType: "iceConnectionState",
							result: "success"
						}), !this.sentSubscriptionAfterConnected_ && this.pendingSubscription_.length > 0)) {
						Hn.warn("remote [".concat(this.userId_, "] send pending subscription after PeerConnection is connected"));
				...
				value: function(e) {
					Hn.debug("[" + this.userId_ + "] IceGatheringStateChange iceGatheringState: " + e.target.iceGatheringState)
				}
			}, {
				key: "addIceCandidate",
				value: function(e) {
					var t = this;
					Hn.info("[" + this.userId_ + "] add remote ice candidate: " + e.candidate), this.peerConnection_.addIceCandidate(
						e).then(function() {
						ju({
						...
						ju({
							eventType: "addIceCandidate",
							result: "failed"
						}), Hn.error("[" + t.userId_ + "] failed to addIceCandidate " + e)
					})
				}
			}, {
				key: "hitTest",
				...
				value: function(e) {
					var t = this;
					Hn.debug("[".concat(this.userId_, "] updateRemoteDescription ").concat(e.sdp));
					...
					this.peerConnection_.setRemoteDescription(e).then(function() {
						if (ju({
								...
								kind: "offer",
								result: "success"
							}), Hn.info("remote [".concat(t.userId_, "] update remoteDescription success")), "unified-plan" === t.sdpSemantics_) {
							var r = function(e, t) {
								var n = xp.parse(e).media,
									r = xp.parse(t).media;
								return {
						...
						i && (Hn.debug("mark ".concat(i.getType(), " stream exit subscription cycle")), i.setInSubscriptionCycle(0))
					}).catch(function(e) {
						ju({
							eventType: "setRemoteDescription",
							kind: "offer",
							result: "failed"
						}), Hn.error("remote [".concat(t.userId_, "] update remoteDescription failed ").concat(e))
					})
				}
			}, {
				key: "addRemoteTrack",
				value: function(e) {
					...
					e.forEach(function(e) {
						var n = e.mid,
							r = Op(e.ssrcs[0].id) === _d ? vd : md,
							i = t.peerConnection_.getReceivers()[n];
						if (i && i.track) {
							Hn.info("remote [".concat(t.userId_, "] add ").concat(i.track.kind, " track ").concat(i.track.id));
							var o = t.remoteStreams_.get(r);
							if (o) o.getMediaStream().addTrack(i.track), "audio" === i.track.kind ? o.setHasAudio(1) : o.setHasVideo(
								1), t.emitter_.emit(Md, {
								stream: o
							});
							else {
								Hn.debug("remoteStream for msid:".concat(r, " not exist"));
								var a = new MediaStream;
								a.addTrack(i.track), (o = new fp({
									type: r === md ? "main" : "auxiliary",
									userId: t.userId_
				...
				value: function(e) {
					var t = this;
					e.forEach(function(e) {
						var n = Op(e.ssrcs[0].id),
							r = n === gd ? "video" : n === _d ? "auxVideo" : "audio";
						Hn.info("remote [".concat(t.userId_, "] [").concat(r, "] track was removed"));
						var i = "auxVideo" === r ? vd : md,
							o = t.remoteStreams_.get(i);
						o && (i !== vd && 0 !== o.getMediaStream().getTracks().length || o.isInSubscriptionCycle() ? ("audio" ===
							r ? o.setHasAudio(0) : o.setHasVideo(0), t.emitter_.emit(Md, {
								stream: o
							})) : (Hn.info("[".concat(t.userId_, "] remote stream ").concat(i, " removed")), t.remoteStreams_.delete(
							i), t.emitter_.emit(Ld, {
							stream: o
						})))
					})
				}
				...
				value: function(e, t) {
					...
					r.filter(function(e) {
						var t, r = i.find(function(t) {
							...
							o = gd;
						if ("audio" === e.type) void 0 !== r && void 0 !== r.ssrcs || !e.ssrcs || (Hn.info("remote [".concat(n.userId_,
							"] [audio] track was removed")), (t = n.remoteStreams_.get(o)) && (0 === t.getMediaStream().getTracks()
							.length ? t.isInSubscriptionCycle() || (Hn.info("[".concat(n.userId_, "] remote stream ").concat(o,
								" removed")), n.remoteStreams_.delete(o), n.emitter_.emit(Ld, {
								stream: t
							})) : (t.setHasAudio(0), n.emitter_.emit(Md, {
								stream: t
							}))));
							...
							var a = 0,
								s = 0;
							void 0 === r.ssrcs && 2 === e.ssrcGroups.length ? (Hn.info("remote [".concat(n.userId_,
									"] [main & aux video] tracks were removed")), a = 1, s = 1) : void 0 === r.ssrcs && 1 === e.ssrcGroups.length ?
								(Hn.info("remote [".concat(n.userId_, "] [main video] track was removed")), a = 1) : e.ssrcGroups.length >
								r.ssrcGroups.length && (Hn.info("remote [".concat(n.userId_, "] [auxiliary video] track was removed")),
									s = 1), s && (o = vd, Hn.info("remote [".concat(n.userId_, "] remote stream ").concat(o, " removed")),
									(t = n.remoteStreams_.get(o)) && !t.isInSubscriptionCycle() && (n.remoteStreams_.delete(o), n.emitter_.emit(
										Ld, {
											stream: t
										}))), a && (o = md, (t = n.remoteStreams_.get(o)) && (0 === t.getMediaStream().getTracks().length ? t.isInSubscriptionCycle() ||
									(Hn.info("remote [".concat(n.userId_, "] remote stream ").concat(o, " removed")), n.remoteStreams_.delete(
										o), n.emitter_.emit(Ld, {
										stream: t
									})) : (t.setHasVideo(0), n.emitter_.emit(Md, {
										stream: t
									}))))
						}
					})
				...
				value: function(e) {
					...
					this.peerConnection_.setRemoteDescription(e).then(function() {
						...
						var e = t.peerConnection_.localDescription;
						t.signalChannel_.send(Tu, e, t.tinyId_), Hn.info("remote [".concat(t.userId_,
							"] accepted remote offer and acknowledged answer")), t.isSdpExchanged_ = 1, t.sendIceCandidate()
					}).catch(function(e) {
						ju({
							eventType: "setRemoteDescription",
							kind: "offer",
							result: "failed"
						}), Hn.error("remote [".concat(t.userId_, "] failed to accept remote offer"))
					})
				}
			}, {
				key: "setMutedState",
				value: function(e, t) {
					if (this.isUplink_) {
						...
						Hn.info("".concat(this.userId_, " set muted state: ").concat(e, " [").concat(t ? "mute" : "unmute", "]")),
							this.signalChannel_.send(Au, n)
					}
				}
			}, {
				key: "onSubscription",
				value: function(e) {
					...
					if (this.hitTest(n)) {
						...
						if (void 0 !== i) {
							...
							var o = i.stream;
							Hn.info("remote [".concat(this.userId_, "] ").concat(o.getType(), " stream ").concat(i.type, " result: ").concat(
								r ? "success" : "failure")), "subscribe" === i.type ? (ju({
								eventType: "subscribe",
								result: 0 === t.errCode ? "success" : "failed"
							}), this.emitter_.emit(Vd, {
								result: r,
								stream: o
							})) : (ju({
								eventType: "unsubscribe",
								result: 0 === t.errCode ? "success" : "failed"
							}), this.emitter_.emit(Ud, {
								result: r,
								stream: o
							}))
						}
						if (this.pendingSubscription_.length > 0) {
							...
							Hn.info("schedule a pending subscription"), this.doSendSubscription(a.data, a.stream)
						}
					}
				}
			}, {
				...
				value: function(e, t) {
					void 0 === t || "main" === e.getType() && void 0 !== t.audio && void 0 !== t.video && t.audio === this.subscribeState_
						...
						this.subscribeState_.auxiliary === t.video ? this.emitter_.emit(Vd, {
							stream: e,
							result: 1
							...
							Hn.info("subscribe ".concat(e.getType(), " stream with options ").concat(JSON.stringify(t), " state: ").concat(
								JSON.stringify(this.subscribeState_))), this.sendSubscription(e, "subscribe"))
				}
			}, {
				key: "unsubscribe",
				value: function(e) {
					"main" === e.getType() ? (this.subscribeState_.audio = 0, this.subscribeState_.video = 0) : this.subscribeState_
						.auxiliary = 0, Hn.info("unsubscribe ".concat(e.getType(), " stream with ").concat(JSON.stringify(this.subscribeState_))),
				...
				value: function(e, t) {
					...
					this.pendingSubscription_.length > 0 ? Hn.debug("queue the subscription for later handling") : this.doSendSubscription(
				...
				value: function(e, t) {
					...
					"connected" === this.peerConnection_.connectionState || "completed" === this.peerConnection_.connectionState ?
						(t && this.pendingStreams_.push(t), Hn.debug("doSendSubscription() send SUBSCRIBE command"), this.signalChannel_
							.send(Ou, e), this.isSubscriptionPending_ = 1, this.subscriptionTimeout_ = setTimeout(function() {
								if (n.isSubscriptionPending_)
									if (Hn.warn("subscription timeout"), n.subscriptionRetryCount_ += 1, n.subscriptionRetryCount_ <= 3) {
										Hn.warn("resend subscription");
										var e = n.pendingSubscription_[0].data;
										n.doSendSubscription(e)
									} else Hn.error("remote server not response to subscription"), n.pendingSubscription_.shift(), n.pendingStreams_
										.shift(), n.isSubscriptionPending_ = 0, n.subscriptionRetryCount_ = 0, n.emitter_.emit(Fd, new Mu({
											code: Lu.SUBSCRIPTION_TIMEOUT,
											message: "remote server not response to subscription"
										}))
							}, 2e3)) : Hn.warn("remote ".concat(this.userId_, " try to send subscription when connectionState ").concat(
		...
		jp = function() {
			...
			return nt(e, [{
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							...
							case 11:
								...
								return (d = lt(u.value, 2))[0], p = d[1], e.next = 15, this.getReceiverStats(p);
							case 15:
								l = e.sent, i.push(l);
							case 17:
								o = 1, e.next = 11;
				...
				key: "prepareReport",
				value: function(e, t) {
					gu(e.senderStats) || (t.uint32_delay = e.senderStats.rtt, t.AudioReportState.uint32_audio_enc_pkg_br = e.senderStats
					...
					if (this.prevReport_ = JSON.parse(JSON.stringify(t)), gu(n)) t.AudioReportState.uint32_audio_enc_pkg_br = 8 *
						...
						for (var r = t.VideoReportState.VideoDecState.length, i = 0; i < r; i++) {
							for (var o = t.VideoReportState.VideoDecState[i], a = o.uint64_sender_uin, s = o.uint32_video_real_recv_pkg,
								...
								var p = n.VideoReportState.VideoDecState[d];
								if (p.uint64_sender_uin === a) {
									(s -= p.uint32_video_real_recv_pkg) <= 0 && (s = 0), (c -= p.uint32_video_recv_br) <= 0 && (c = 0), (u -=
										p.uint32_video_recv_fps) < 0 && (u = 0);
									break
								}
							}
						...
						for (var l = 0; l < r; l++) {
							for (var f = t.AudioReportState.AudioDecState[l], h = f.uint32_audio_real_recv_pkg, m = f.uint32_audio_flow,
							...
							t.AudioReportState.AudioDecState[l].uint32_audio_real_recv_pkg = h, t.AudioReportState.AudioDecState[l].uint32_audio_flow =
								m, t.AudioReportState.AudioDecState[l].uint32_audio_real_recv_br = 8 * m / 2
						}
		...
		Vp = function() {
			function e(t) {
				if (et(this, e), this.mode_ = t.mode, this.sdpSemantics_ = "plan-b", void 0 !== t.sdpSemantics ? this.sdpSemantics_ =
					t.sdpSemantics : dd() && (this.sdpSemantics_ = "unified-plan"), Hn.info("using sdpSemantics: " + this.sdpSemantics_),
					this.sdkAppId_ = t.sdkAppId, this.userId_ = t.userId, this.userSig_ = t.userSig, this.roomId_ = 0, this.recordId_ =
					null, this.pureAudioPushMode_ = null, this.version_ = t.version, Hn.setConfig({
						sdkAppId: this.sdkAppId_,
						userId: this.userId_,
						version: this.version_
					}), void 0 !== t.recordId) {
					if (!Number.isInteger(Number(t.recordId))) throw new Mu({
						code: Lu.INVALID_PARAM,
						message: "recordId must be an integer number"
					});
					this.recordId_ = t.recordId
				}
				if (void 0 !== t.pureAudioPushMode) {
					if (!Number.isInteger(Number(t.pureAudioPushMode))) throw new Mu({
						code: Lu.INVALID_PARAM,
				...
				this.disableReceiver_ = 0, this.signalChannel_ = null, this.role_ = "anchor", this.privateMapKey_ = "", this.tinyId_ =
					...
					null, this.isPublishing_ = 0, this.uplinkConnection_ = null, this.emitter_ = new _u, this.signalInfo_ = {}, this.isInitialized_ =
					0, this.isJoined_ = 0, this.heartbeat_ = -1, this.stats_ = new jp, this.joinTimeout_ = -1, this.publishTimeout_ = -
			...
			return nt(e, [{
				key: "setProxyServer",
				value: function(e) {
					if (!e.startsWith("wss://")) throw new Mu({
						code: Lu.INVALID_PARAMETER,
				...
				key: "getMainUrl",
				value: function() {
					return this.proxy_ ? this.proxy_ : Np("wss://qcloud.rtc.qq.com:8687")
				}
			}, {
				key: "getBackupUrl",
				value: function() {
					return this.proxy_ ? this.proxy_ : Np("wss://bk.rtc.qq.com:8687")
				}
			}, {
				key: "setTurnServer",
				value: function(e) {
				...
				value: function() {
					var e = this;
					return new Promise(function(t, n) {
						Hn.info("setup signal channel for userId: " + e.userId_), e.signalChannel_ = new Uu({
							sdkAppId: e.sdkAppId_,
							userId: e.userId_,
							userSig: e.userSig_,
							url: e.getMainUrl(),
							backupUrl: e.getBackupUrl(),
							version: e.version_
						}), e.signalChannel_.on(yu, function(t) {
							Hn.info("SignalChannel state changed from ".concat(t.prevState, " to ").concat(t.state)), e.emitter_.emit(
								Jd, t)
						}), e.signalChannel_.on(Su, function(t) {
							e.isInitialized_ ? (e.closeUplink(), e.emitter_.emit(Zd, t)) : n(t)
						}), e.signalChannel_.on(Cu.CHANNEL_SETUP_FAILED, function(e) {
							Hn.error("signal channel setup failed"), n(e)
						}), e.signalChannel_.on(Cu.CHANNEL_SETUP_SUCCESS, function(n) {
							e.signalInfo_ = n.signalInfo, e.tinyId_ = e.signalInfo_.tinyId, e.isInitialized_ = 1, t()
						}), e.signalChannel_.on(Cu.PEER_JOIN, function(t) {
							e.disableReceiver_ || e.onPeerJoin(t.data)
						}), e.signalChannel_.on(Cu.PEER_LEAVE, function(t) {
							e.onPeerLeave(t.data)
						}), e.signalChannel_.on(Cu.UPDATE_REMOTE_MUTE_STAT, function(t) {
							e.onUpdateRemoteMuteStat(t.data)
						}), e.signalChannel_.on(Cu.CLINET_BANNDED, function(t) {
							var n = t.data.content;
							if (e.closeUplink(), "banned" === n.type) {
								var r = "you got banned by account admin";
								Hn.error("user was banned because of " + r), e.onClientBanned(r)
							} else if ("kick" === n.type) {
								var i = "duplicated userId joining the room";
								Hn.error("user was banned because of " + i), e.onClientBanned(i)
							} else Hn.error("Relay server timeout observed"), e.emitter_.emit(Zd, new Mu({
								code: Lu.SERVER_TIMEOUT,
								message: "Relay server timeout observed"
							}))
						}), e.signalChannel_.on(Cu.REQUEST_REBUILD_SESSION, function(t) {
							...
							try {
								for (var s, c = e.connections_[Symbol.iterator](); !(i = (s = c.next()).done); i = 1) {
									var u = lt(s.value, 2),
										...
										p = u[1];
									n.push(d);
									var l = p.getPeerConnection().remoteDescription;
									l && r.push(l.sdp)
								}
							} catch (h) {
								o = 1, a = h
							...
							try {
								Hn.info("[".concat(e.userId_, "] reconnect - rebuild session with data: ").concat(JSON.stringify(f))),
									e.signalChannel_.send(xu, f)
							} catch (nl) {
								Hn.error("reconnect failed because rebuild session failed")
							}
				...
				value: (s = Ze(regeneratorRuntime.mark(function e(t) {
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								return e.prev = 0, e.next = 3, this.initialize();
							case 3:
								return e.next = 5, this.doJoin(t);
							case 5:
								e.next = 11;
								break;
							case 7:
								throw e.prev = 7, e.t0 = e.catch(0), ju({
									eventType: "join",
									result: "failed"
								}), e.t0;
							case 11:
				...
				value: function(e) {
					...
					return new Promise(function(n, r) {
						if (!t.isInitialized_) throw new Mu({
							code: Lu.INVALID_OPERATION,
							message: "SignalChannel is not ready yet"
						});
						if (t.isJoined_) throw new Mu({
							code: Lu.INVALID_OPERATION,
							message: "duplicate join() called"
						});
						t.roomId_ = e.roomId, void 0 !== e.role && (t.role_ = e.role);
						var i = "";
						void 0 !== e.privateMapKey && (i = e.privateMapKey), t.privateMapKey_ = i, Hn.info(
						...
						var o = t.signalInfo_,
							a = {
								...
								browserVersion: ad,
								closeLocalMedia: 1,
								trtcscene: "live" === t.mode_ ? ld : pd,
								trtcrole: "anchor" === t.role_ ? fd : hd,
								report: null
							};
						t.joinTimeout_ = setTimeout(function() {
							Hn.error("join room timeout observed"), r(new Mu({
								code: Lu.JOIN_ROOM_FAILED,
								message: "join room timeout"
							}))
						}, 2e3), t.signalChannel_.send(Eu, a), t.signalChannel_.once(Cu.JOIN_ROOM_RESULT, function(e) {
							clearTimeout(t.joinTimeout_), t.joinTimeout_ = -1;
							var i = e.data.content.ret;
							i ? (Hn.error("Join room failed result: " + i + " error: " + e.data.content.error), r(new Mu({
								code: Lu.JOIN_ROOM_FAILED,
								message: "Failed to join room - " + e.data.content.error
							}))) : (t.isJoined_ = 1, Hn.info("Join room success, start heartbeat"), t.startHeartbeat(), n())
						})
					})
				}
			}, {
				...
				value: (a = Ze(regeneratorRuntime.mark(function e() {
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							...
							case 7:
								this.isJoined_ = 0, this.destroy(), ju({
									eventType: "leave",
									result: "success"
								});
							case 10:
				...
				value: function() {
					var e = this;
					return new Promise(function(t, n) {
						return e.isJoined_ ? (Hn.info("leave() => ".concat(e.userId_, " is leaving room")), e.stopHeartbeat(), e.closeConnections(),
							e.mutedStates_.clear(), e.clearPublishTimeout(), e.clearUnpublishTimeout(), e.closeUplink(), t()) : t()
					})
				}
			}, {
				...
				key: "destroy",
				value: function() {
					if (this.isJoined_) throw Hn.warn("please call leave() before destroy() client"), new Mu({
						code: Lu.INVALID_OPERATION,
						message: "Please call leave() before destory() the client"
					});
					Hn.info("destroying SignalChannel"), this.signalChannel_ && (this.signalChannel_.close(), this.signalChannel_ =
						null)
				}
			}, {
				key: "publish",
				value: function(e) {
					...
					return new Promise(function(n, r) {
						...
						if (t.localStream_) throw new Mu({
							code: Lu.INVALID_OPERATION,
							message: "duplicate publishing, please unpublish and then re-publish"
						});
						if (t.isPublishing_) throw new Mu({
							code: Lu.INVALID_OPERATION,
							message: "previous publishing is ongoing, please avod re-publishing"
						});
						t.isPublishing_ = 1, Hn.info("publish() => publishing ".concat(t.userId_, "'s local stream"));
						var i = new Mp({
							userId: t.userId_,
							tinyId: t.tinyId_,
							client: t,
						...
						i.initialize(), t.publishTimeout_ = setTimeout(function() {
							Hn.error("failed to publish because of timeout"), ju({
								eventType: "publish",
								result: "failed"
							}), r(new Mu({
								code: Lu.UNKNOWN,
							...
							t.clearPublishTimeout(), t.isPublishing_ = 0, Hn.error("failed to publish stream"), ju({
								eventType: "publish",
								result: "failed"
							}), r(e)
						}), i.on(jd, function(e) {
							t.clearPublishTimeout(), t.isPublishing_ = 0, t.localStream_ = e.stream, t.localStream_.setConnection(i),
								t.uplinkConnection_ = i, ju({
									eventType: "publish",
									result: "success"
								}), n()
						}), i.on(Fd, function(e) {
							t.emitter_.emit(Zd, e)
						})
					})
				}
			}, {
				...
				value: function(e) {
					...
					return new Promise(function(n, r) {
						...
						if (e !== t.localStream_) throw new Mu({
							code: Lu.INVALID_PARAMETER,
							message: "stream has not been published yet"
						});
						Hn.info("unpublish() => unpublishing ".concat(t.userId_, "'s local stream")), Hn.info(
							"unpublish() - request remote server for closing RTCPeerConnection"), t.doUnpublish().then(function() {
							ju({
								eventType: "unpublish",
								result: "success"
							}), n()
				...
				value: function() {
					var e = this;
					return new Promise(function(t, n) {
						e.signalChannel_.send(Iu), e.unpublishTimeout_ = setTimeout(function() {
							Hn.warn("unpublish() timeout"), e.closeUplink()
						}, 2e3), e.signalChannel_.once(Cu.CLOSE_PEER_ACK, function(n) {
							return e.clearUnpublishTimeout(), Hn.info("Remote server CLOSE_PEER_ACK, close uplink connection"), e.closeUplink(),
								t()
						})
					})
				}
				...
				key: "subscribe",
				value: function(e, t) {
					if (!e.isRemote()) throw new Mu({
						code: Lu.INVALID_PARAMETER,
						message: "try to subscribe a local stream"
					});
					Hn.info("subscribe() => subscribe to [".concat(e.getUserId(), "] ").concat(e.getType(),
				...
				value: function(e) {
					...
					Hn.info("unsubscribe() => unsubscribe to [".concat(e.getUserId(), "] ").concat(e.getType(), " stream")), e.getConnection()
						.unsubscribe(e)
				}
			}, {
				key: "switchRole",
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							...
							case 2:
								...
								if (this.role_ = t, Hn.info("switchRole() => switch role to: " + t), this.isJoined_) {
									e.next = 7;
									break
								}
								return e.abrupt("return");
				...
				value: function(e) {
					Hn.info("[" + this.userId_ + "] setDefaultMuteRemoteStreams muted: " + e), this.disableReceiver_ = e
				}
			}, {
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							...
							case 6:
								...
								return (s = lt(a.value, 2))[0], c = s[1], e.next = 10, this.stats_.getReceiverStats(c);
							case 10:
				...
				value: function() {
					if (-1 === this.heartbeat_) {
						Hn.info("startHeartbeat..."), this.heartbeat_ = setInterval(this.doHeartbeat.bind(this), 2e3)
					}
				}
			}, {
				key: "stopHeartbeat",
				value: function() {
					-1 !== this.heartbeat_ && (Hn.info("stopHeartbeat"), clearInterval(this.heartbeat_), this.heartbeat_ = -1)
				}
			}, {
				key: "doHeartbeat",
				value: function() {
					...
					this.stats_.getStatsReport(this.uplinkConnection_, this.connections_).then(function(t) {
						...
						n.WebRTCQualityReq.AudioReportState.uint32_microphone_status = r, e.signalChannel_.send(Pu, n)
					})
				}
			}, {
				key: "onPeerJoin",
				value: function(e) {
					var t = this,
						...
						i = n.srctinyid,
						o = n.remoteoffer;
					Hn.info("remote peer [".concat(r, "] is online")), this.emitter_.emit(Wd, {
						userId: r
					});
					var a = new Mp({
						userId: r,
					...
					this.connections_.set(i, a), a.initialize(), a.setRemoteOffer(o), a.on(Nd, function(e) {
						t.emitter_.emit(Gd, {
							stream: e.stream
						})
					}), a.on(Ld, function(e) {
				...
				value: function(e) {
					...
					i && (void 0 === r && (r = i.getUserId()), Hn.info("remote peer [".concat(r, "] is leaving")), this.emitter_.emit(
						qd, {
							userId: r
						...
						if (0 !== n && n !== t.tinyId_)
							if (t.connections_.get(n)) {
								...
								if (void 0 === c) return t.mutedStates_.set(n, {
									...
									audioMuted: a,
									videoMuted: s
								}), i && (s ? t.emitter_.emit($d, {
									userId: r
								}) : t.emitter_.emit(Qd, {
									userId: r
								})), void(o && (a ? t.emitter_.emit(Kd, {
									userId: r
								}) : t.emitter_.emit(Yd, {
									userId: r
								})));
								o && c.audioMuted !== a && (a ? t.emitter_.emit(Kd, {
									userId: r
								}) : t.emitter_.emit(Yd, {
									userId: r
								}));
								var u = !s && i;
								(!c.videoMuted && c.hasVideo) !== u && (u ? t.emitter_.emit(Qd, {
									userId: r
								}) : t.emitter_.emit($d, {
									userId: r
				...
				key: "onClientBanned",
				value: function(e) {
					this.emitter_.emit(Xd, new Mu({
						code: Lu.CLIENT_BANNED,
				...
				value: function(e) {
					...
					Hn.warn("triggerReconnectForTest exitcode: " + e), this.signalChannel_.send(Nu, t)
				}
			}, {
		...
		Up = function() {
			var e = Ze(regeneratorRuntime.mark(function e(t) {
				...
				return regeneratorRuntime.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
							return n = Fp(t), Hn.info("getUserMedia with contraints: " + JSON.stringify(n)), e.next = 4, navigator.mediaDevices
								.getUserMedia(n);
						case 4:
			...
			return regeneratorRuntime.wrap(function(e) {
				for (;;) switch (e.prev = e.next) {
					case 0:
						...
						return r = Bp(t), Hn.info("getUserMedia with constraints: " + JSON.stringify(r)), e.next = 6, navigator.mediaDevices
							.getUserMedia(r);
					case 6:
						n = e.sent;
					case 7:
						return i = Hp(t), Hn.info("getDisplayMedia with contraints: " + JSON.stringify(i)), e.next = 11,
			...
			return ot(t, lp), nt(t, [{
					...
					return new Promise(function(t, n) {
						if (void 0 === e.audio_) {
							...
							return void 0 !== e.audioSource_ && (r.addTrack(e.audioSource_), e.setHasAudio(1)), void 0 !== e.videoSource_ &&
								(r.addTrack(e.videoSource_), e.setHasVideo(1)), e.setMediaStream(r), ju({
									eventType: "stream-initialize",
									kind: "custom",
									result: "success"
								}), t()
						}
						e.screen_ ? (Hn.info("initialize stream audio: " + e.audio_ + " screen: " + e.screen_), Gp({
							audio: e.audio_,
							...
							ju({
								...
								result: "failed"
							}), Hn.error("getDisplayMedia error observed " + e), n(e)
						}).then(function(n) {
							return e.setMediaStream(n), e.setHasAudio(e.audio_), e.setHasVideo(1), e.listenForScreenSharingStopped(
								e.getVideoTrack()), e.setVideoContentHint("detail"), ju({
								eventType: "stream-initialize",
								kind: "getDisplayMedia",
								result: "success"
							}), t()
						})) : (Hn.info("initialize stream audio: " + e.audio_ + " video: " + e.video_), Up({
							audio: e.audio_,
							video: e.video_,
							...
							ju({
								...
								kind: "getUserMedia",
								result: "failed"
							}), Hn.error("getUserMedia error observed " + e), n(e)
						}).then(function(n) {
							return e.setMediaStream(n), e.setHasAudio(e.audio_), e.setHasVideo(e.video_), Hn.debug(
								"gotStream hasAudio: " + e.hasAudio_ + " hasVideo: " + e.hasVideo_), ju({
								eventType: "stream-initialize",
								kind: "getUserMedia",
								result: "success"
							}), t()
				...
				value: function(e) {
					...
					e.addEventListener("ended", function(e) {
						Hn.info("screensharing was stopped because the video track is ended"), t.emitter_.emit(tp)
					})
				}
			}, {
				key: "muteAudio",
				value: function() {
					var e = pt(at(t.prototype), "muteAudio", this).call(this);
					if (e) {
						Hn.info("localStream mute audio");
				...
				key: "muteVideo",
				value: function() {
					Hn.info("localStream mute video");
					var e = pt(at(t.prototype), "muteVideo", this).call(this);
					if (e) {
						var n = this.getConnection();
				...
				key: "unmuteAudio",
				value: function() {
					var e = pt(at(t.prototype), "unmuteAudio", this).call(this);
					if (e) {
						Hn.info("localStream unmute audio");
						var n = this.getConnection();
				...
				key: "unmuteVideo",
				value: function() {
					Hn.info("localStream unmute video");
					var e = pt(at(t.prototype), "unmuteVideo", this).call(this);
					if (e) {
						var n = this.getConnection();
				...
				value: function(e) {
					var t;
					"object" === Qe(e) ? t = e : void 0 === (t = Wp.get(e)) && (t = Wp.get("standard")), Hn.info(
				...
				value: function(e) {
					var t;
					"object" === Qe(e) ? t = e : void 0 === (t = zp.get(e)) && (t = zp.get("480p")), Hn.info("setVideoProfile " +
						JSON.stringify(t)), this.videoProfile_ = t, this.videoBitrate_ = t.bitrate
				}
			}, {
				key: "getVideoBitrate",
				value: function() {
				...
				value: function(e) {
					var t = e;
					"object" !== Qe(e) && void 0 === (t = Jp.get(e)) && (t = Jp.get("1080p")), Hn.info("setScreenProfile " + JSON
						.stringify(e)), this.screenProfile_ = t, this.videoBitrate_ = t.bitrate
				}
			}, {
				key: "getVideoProfile",
				value: function() {
				...
				value: function(e) {
					...
					t && "contentHint" in t && (Hn.info("set video track contentHint to: " + e), t.contentHint = e, t.contentHint !==
						e && Hn.warn("Invalid video track contentHint: " + e))
				}
			}, {
				key: "switchDevice",
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								...
								return e.abrupt("return");
							case 2:
								if ("audio" === n && (this.microphoneId_ = r), "video" === n && ("user" === r || "environment" ===
										r ? this.facingMode_ = r : this.cameraId_ = r), this.getMediaStream()) {
									e.next = 6;
									break
								}
								return e.abrupt("return");
							case 6:
								return Hn.info("switchDevice " + n + " to: " + r), "video" === n && (Qu || Yu) && (i = this.getVideoTrack()) &&
									i.stop(), e.next = 10, Up({
										audio: this.audio_,
										video: this.video_,
							...
							case 16:
								return Hn.info("swichDevice - restart audio/video player"), pt(at(t.prototype), "restartAudio", this)
									.call(this), pt(at(t.prototype), "restartVideo", this).call(this), e.abrupt("return");
							case 20:
							case "end":
								return e.stop()
						}
				...
				value: (n = Ze(regeneratorRuntime.mark(function e(n) {
					...
					return regeneratorRuntime.wrap(function(e) {
						for (;;) switch (e.prev = e.next) {
							...
							case 10:
								if ("audio" === n.kind ? (r.removeTrack(r.getAudioTracks()[0]), r.addTrack(n), pt(at(t.prototype),
										"restartAudio", this).call(this)) : (r.removeTrack(r.getVideoTracks()[0]), r.addTrack(n), pt(at(t.prototype),
	...
	var $p, Yp, Qp, Xp, Zp, el = new Kp,
		tl = {
			...
			checkSystemRequirements: (Zp = Ze(regeneratorRuntime.mark(function e() {
				var t, n, r;
				return regeneratorRuntime.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
							return t = cd(), e.next = 3, ud();
						case 3:
							return n = e.sent, (r = !Zu && t && n) || Hn.error("".concat(ad, " isWebRTCSupported: ").concat(t,
			...
			getDevices: (Xp = Ze(regeneratorRuntime.mark(function e() {
				var t;
				return regeneratorRuntime.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
			...
			getCameras: (Qp = Ze(regeneratorRuntime.mark(function e() {
				var t;
				return regeneratorRuntime.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
			...
			getMicrophones: (Yp = Ze(regeneratorRuntime.mark(function e() {
				var t;
				return regeneratorRuntime.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
			...
			getSpeakers: ($p = Ze(regeneratorRuntime.mark(function e() {
				var t;
				return regeneratorRuntime.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
			...
			createClient: function(e) {
				...
				return new Vp(it({}, t, e))
			},
			createStream: function(e) {
				if (!(void 0 === e.audio && void 0 === e.video || void 0 === e.audioSource && void 0 === e.videoSource)) throw new Mu({
					code: Lu.INVALID_PARAMETER,
				...
				if (void 0 !== e.screen && 1 == e.screen && 1 == e.video) throw new Mu({
					code: Lu.INVALID_PARAMETER,
					message: "screen/video options are mutually exclusive, they can not be both true"
				});
				if (void 0 !== e.screen && 1 == e.screen && !this.isScreenShareSupported()) throw new Mu({
					code: Lu.INVALID_OPERATION,
	...
	return Hn.info("TRTC Web SDK Version: " + tl.VERSION), Hn.info("UserAgent: " + navigator.userAgent), Hn.info(
		"URL of current page: " + location.href), tl
});
